...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m18(hashtag) => "Du kommer bli den första som använder #${hashtag}";

  static m19(platform) => "Kör på ${platform}";

  static m20(currentUserLanguage) => "Språk (${currentUserLanguage})";

  static m21(limit) => "Filen är för stor (gräns: ${limit} MB)";
  ...
  static m27(communityName) =>
      "Det finns ett nytt inlägg i c/${communityName}.";
  ...
  static m31(commentsCount) => "Visa alla ${commentsCount} kommentarer";
  ...
  static m34(name) => "${name} har inte delat något ännu.";

  static m35(postCreatorUsername) => "@${postCreatorUsername}s kretsar";

  static m36(description) =>
      "Webbsidan svarade med ett fel vid förhandsgranskning av länken: ${description}";
  ...
  static m39(username) => "Är du säker på att du vill blockera @${username}?";

  static m40(userName) => "Bekräfta ${userName}s kontaktförfrågan";

  static m41(userName) => "Lägg till ${userName} som kontakt";

  static m42(userName) => "Ta bort ${userName} som kontakt";

  static m43(limit) => "Bilden är för stor (gräns: ${limit} MB)";

  static m44(username) => "Användarnamnet @${username} är upptaget";

  static m45(searchQuery) =>
      "Ingen emoji hittades som matchar \'${searchQuery}\'.";

  static m46(searchQuery) => "Inga listor hittades för \'${searchQuery}\'";

  static m47(prettyUsersCount) => "${prettyUsersCount} konton";

  static m48(prettyUsersCount) => "${prettyUsersCount} Konton";

  static m49(groupName) => "Visa alla ${groupName}";

  static m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Hej, jag vill bjuda in dig till Somus.\n\nFör Apple, ladda först ner TestFlight-appen från iTunes (${testFlightLink}) och ladda sedan ner Somus-appen (${iosLink}).\n\nFör Android, ladda ner Somus-appen från Play Store (${androidLink}).\n\nEfter det så klistrar du in den här personliga inbjudningslänken i \'Registrera dig\'-formuläret i Somus-appen: ${inviteLink}";

  static m51(username) => "Gick med under användarnamnet @${username}";

  static m52(email) => "Väntande, inbjudan skickad till ${email}";

  static m53(maxLength) =>
      "Listans namn får inte vara längre än ${maxLength} tecken.";

  static m54(maxLength) => "Bion kan inte vara längre än ${maxLength} tecken.";

  static m55(maxLength) =>
      "En plats kan inte vara längre än ${maxLength} tecken.";

  static m56(age) => "På Somus sedan ${age}";

  static m57(takenConnectionsCircleName) =>
      "Kretsnamnet \'${takenConnectionsCircleName}\' är upptaget";

  static m58(listName) => "Listnamnet \'${listName}\' är upptaget";

  static m59(searchQuery) => "Inga resultat hittades för \'${searchQuery}\'.";

  static m60(resourcePluralName) => "Inga ${resourcePluralName} hittades.";

  static m61(resourcePluralName) => "Sök ${resourcePluralName} ...";

  static m62(searchQuery) =>
      "Inga gemenskaper hittades för \'${searchQuery}\'.";

  static m63(searchQuery) => "Inga hashtaggar hittades för \'${searchQuery}\'.";

  static m64(searchQuery) => "Inga resultat hittades för \'${searchQuery}\'.";

  static m65(searchQuery) => "Inga användare hittades för \'${searchQuery}\'.";

  static m66(searchQuery) => "Söker efter \'${searchQuery}\'";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static _notInlinedMessages(_) => <String, Function>{
        "application_settings__comment_sort_newest_first":
            MessageLookupByLibrary.simpleMessage("Nyast först"),
        "application_settings__comment_sort_oldest_first":
            MessageLookupByLibrary.simpleMessage("Äldst först"),
        "application_settings__link_previews":
            MessageLookupByLibrary.simpleMessage(
                "Förhandsgranskning av länkar"),
        ...
        "application_settings__link_previews_autoplay_wifi_only":
            MessageLookupByLibrary.simpleMessage("Endast Wifi"),
        ...
        "application_settings__videos":
            MessageLookupByLibrary.simpleMessage("Videor"),
        "application_settings__videos_autoplay":
            MessageLookupByLibrary.simpleMessage("Automatisk uppspelning"),
        ...
        "application_settings__videos_sound":
            MessageLookupByLibrary.simpleMessage("Ljud"),
        "application_settings__videos_sound_disabled":
            MessageLookupByLibrary.simpleMessage("Inaktiverat"),
        "application_settings__videos_sound_enabled":
            MessageLookupByLibrary.simpleMessage("Aktiverat"),
        ...
        "auth__create_acc__invalid_token":
            MessageLookupByLibrary.simpleMessage("Ogiltig kod"),
        ...
        "auth__create_acc__link_invalid_error":
            MessageLookupByLibrary.simpleMessage("Länken är ogiltig."),
        ...
        "auth__create_acc__suggested_communities":
            MessageLookupByLibrary.simpleMessage(
                "🥳 Kom igång genom att gå med i följande gemenskaper."),
        ...
        "auth__create_acc__validating_token":
            MessageLookupByLibrary.simpleMessage("Validerar kod..."),
        ...
        "community__details_favorite":
            MessageLookupByLibrary.simpleMessage("I favoriter"),
        "community__exclude_joined_communities":
            MessageLookupByLibrary.simpleMessage(
                "Uteslut gemenskaper jag är medlem i"),
        ...
        "community__top_posts_excluded_communities_desc":
            MessageLookupByLibrary.simpleMessage(
                "Hantera de gemenskaper som du uteslutit från ditt Utforska-flöde"),
        "community__top_posts_settings":
            MessageLookupByLibrary.simpleMessage("Inställningar för Utforska"),
        ...
        "contextual_account_search_box__suggestions":
            MessageLookupByLibrary.simpleMessage("Förslag"),
        ...
        "drawer__developer_settings":
            MessageLookupByLibrary.simpleMessage("Utvecklarinställningar"),
        ...
        "image_picker__from_camera":
            MessageLookupByLibrary.simpleMessage("Från kameran"),
        "image_picker__from_gallery":
            MessageLookupByLibrary.simpleMessage("Från galleriet"),
        "media_service__crop_image":
            MessageLookupByLibrary.simpleMessage("Beskär bild"),
        ...
        "moderation__report_hashtag_text":
            MessageLookupByLibrary.simpleMessage("Anmäl hashtag"),
        ...
        "moderation__you_have_reported_hashtag_text":
            MessageLookupByLibrary.simpleMessage(
                "Du har anmält den här hashtaggen"),
        ...
        "notifications__comment_user_mention_desc":
            MessageLookupByLibrary.simpleMessage(
                "Bli meddelad när någon nämner dig i en av sina kommentarer"),
        "notifications__comment_user_mention_title":
            MessageLookupByLibrary.simpleMessage("Omnämnande i kommentar"),
        ...
        "notifications__mentioned_in_post_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] nämnde dig i ett inlägg."),
        ...
        "notifications__post_user_mention_desc":
            MessageLookupByLibrary.simpleMessage(
                "Bli meddelad när någon nämner dig i ett av sina inlägg"),
        "notifications__post_user_mention_title":
            MessageLookupByLibrary.simpleMessage("Omnämnande i inlägg"),
        ...
        "notifications__tab_general":
            MessageLookupByLibrary.simpleMessage("Allmänna"),
        "notifications__tab_requests":
            MessageLookupByLibrary.simpleMessage("Förfrågningar"),
        ...
        "notifications__user_new_post_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] publicerade något."),
        "notifications__user_new_post_title":
            MessageLookupByLibrary.simpleMessage("Nytt användarinlägg"),
        "permissions_service__camera_permission_denied":
            MessageLookupByLibrary.simpleMessage(
                "Vi behöver tillstånd att använda din kamera för att du ska kunna ta bilder och spela in videor. Var god och tillåt detta i dina inställningar."),
        "permissions_service__storage_permission_denied":
            MessageLookupByLibrary.simpleMessage(
                "Vi behöver tillstånd att komma åt dina lagringsmedia för att du ska kunna välja mediafiler. Var god och tillåt detta i dina inställningar."),
        ...
        "post__actions_delete_comment_description":
            MessageLookupByLibrary.simpleMessage(
                "Kommentaren och dess svar och reaktioner kommer raderas permanent."),
        "post__actions_delete_description": MessageLookupByLibrary.simpleMessage(
            "Inlägget och dess kommentarer och reaktioner kommer raderas permanent."),
        ...
        "post__close_create_post_label":
            MessageLookupByLibrary.simpleMessage("Stäng nytt inlägg-rutan"),
        "post__close_post":
        ...
        "post__create_new_community_post_label":
            MessageLookupByLibrary.simpleMessage(
                "Skapa ett nytt gemenskapsinlägg"),
        "post__create_new_post_label":
            MessageLookupByLibrary.simpleMessage("Skapa ett nytt inlägg"),
        ...
        "post__is_closed":
            MessageLookupByLibrary.simpleMessage("Stängt inlägg"),
        "post__load_more":
            MessageLookupByLibrary.simpleMessage("Läs in fler inlägg"),
        "post__my_circles":
        ...
        "post__top_posts_title":
            MessageLookupByLibrary.simpleMessage("Utforska"),
        "post__trending_posts_load_more":
            MessageLookupByLibrary.simpleMessage("Läs in äldre inlägg"),
        ...
        "post_body_link_preview__empty": MessageLookupByLibrary.simpleMessage(
            "Länken kunde inte förhandsvisas"),
        "post_body_link_preview__error_with_description": m36,
        "post_body_media__unsupported":
            MessageLookupByLibrary.simpleMessage("Mediatypen stöds inte"),
        "post_uploader__cancelled":
            MessageLookupByLibrary.simpleMessage("Avbrutet!"),
        "post_uploader__cancelling":
            MessageLookupByLibrary.simpleMessage("Avbryter"),
        "post_uploader__compressing_media":
            MessageLookupByLibrary.simpleMessage("Komprimerar media..."),
        "post_uploader__creating_post":
            MessageLookupByLibrary.simpleMessage("Skapar inlägget..."),
        "post_uploader__generic_upload_failed":
            MessageLookupByLibrary.simpleMessage("Uppladdningen misslyckades"),
        "post_uploader__processing":
            MessageLookupByLibrary.simpleMessage("Bearbetar inlägget..."),
        "post_uploader__publishing":
            MessageLookupByLibrary.simpleMessage("Publicerar inlägget..."),
        "post_uploader__success":
            MessageLookupByLibrary.simpleMessage("Klart!"),
        "post_uploader__uploading_media":
            MessageLookupByLibrary.simpleMessage("Laddar upp media..."),
        ...
        "posts_stream__empty_drhoo_title":
            MessageLookupByLibrary.simpleMessage("Det här flödet är tomt."),
        "posts_stream__failed_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "Försök igen om några sekunder"),
        "posts_stream__failed_drhoo_title":
            MessageLookupByLibrary.simpleMessage("Kunde inte läsa in flödet."),
        "posts_stream__refreshing_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage("Uppdaterar flödet."),
        "posts_stream__refreshing_drhoo_title":
            MessageLookupByLibrary.simpleMessage("Håll ut!"),
        "posts_stream__status_tile_empty":
            MessageLookupByLibrary.simpleMessage("Inga inlägg hittades"),
        ...
        "user__edit_profile_community_posts":
            MessageLookupByLibrary.simpleMessage("Gemenskapsinlägg"),
        ...
        "user__follow_button_follow_back_text":
            MessageLookupByLibrary.simpleMessage("Följ tillbaka"),
        ...
        "user__invites_accepted_title":
            MessageLookupByLibrary.simpleMessage("Accepterade"),
        ...
        "user__profile_action_user_post_notifications_disabled":
            MessageLookupByLibrary.simpleMessage(
                "Aviseringar har inaktiverats för nya inlägg"),
        "user__profile_action_user_post_notifications_enabled":
            MessageLookupByLibrary.simpleMessage(
                "Aviseringar har aktiverats för nya inlägg"),
        ...
        "user__profile_in_circles":
            MessageLookupByLibrary.simpleMessage("I kretsar"),
        ...
        "user_search__hashtags":
            MessageLookupByLibrary.simpleMessage("Hashtaggar"),

...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(minLength, maxLength) =>
      "Açıklama karakter sayısı ${minLength} ve ${maxLength} uzunluğu arasında olmalıdır.";

  static m2(minLength, maxLength) =>
      "İsim karakter sayısı ${minLength} ve ${maxLength} uzunluğu arasında olmalıdır.";

  static m3(minLength, maxLength) =>
      "Parola karakteri sayısı ${minLength} ile ${maxLength} uzunluğu arasında olmalıdır.";

  static m4(maxLength) =>
      "Bir kullanıcı adı ${maxLength} karakterden daha uzun olamaz.";

  static m5(maxLength) =>
      "Sıfatlar kısmı ${maxLength} karakterden daha uzun olamaz.";

  static m6(username) =>
      "Topluluk yöneticisi olarak @${username} adlı kullanıcıyı eklemek istediğinizden emin misiniz?";

  static m7(username) =>
      "@${username} adlı kullanıcıyı engellemek istediğinizden emin misiniz?";

  static m8(maxLength) =>
      "Açıklama kısmı ${maxLength} karakterden daha uzun olamaz.";

  static m9(username) =>
      "@${username} adlı kişiyi topluluk yöneticisi olarak eklemek istediğinden emin misin?";
  ...
  static m14(maxLength) =>
      "Kurallar bölümü ${maxLength} karakterden daha uzun olamaz.";
  ...
  static m22(resourceCount, resourceName) =>
      "Hepsini gör ${resourceCount} ${resourceName}";

  static m23(postCommentText) =>
      "Ayrıca [name] [username] yorum yaptı: ${postCommentText}";

  static m24(postCommentText) =>
      "[name] [username] gönderinize yorum yaptı: ${postCommentText}";

  static m25(postCommentText) =>
      "ayrıca [name] [username] yanıtladı: ${postCommentText}";
  ...
  static m29(communityName) =>
      "[name] [username] sizi /c/${communityName} topluluğuna davet etti.";
  ...
  static m33(circlesSearchQuery) =>
      "\'\'\'${circlesSearchQuery}\' ile eşleşen hiçbir çevre bulunamadı.";

  static m34(name) => "${name} henüz bir şey paylaşmadı.";

  static m35(postCreatorUsername) =>
      "@${postCreatorUsername} adlı kullanıcının çevreleri";

  static m36(description) =>
      "Web sitesi hatası ile bağlantıyı önizleyemedi: ${description}";

  static m37(maxLength) =>
      "Çevre adı ${maxLength} karakterden daha uzun olamaz.";
  ...
  static m45(searchQuery) =>
      "\'${searchQuery}\' ile eşleşen hiçbir emoji bulunamadı.";
  ...
  static m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Hey, seni Somus\'ya davet etmek istiyorum.\n\nApple için, önce TestFlight (${testFlightLink}) uygulamasını iTunes\'a indirin ve ardından Somus uygulamasını (${iosLink}) indirin\n\nAndroid için Play Store\'dan indirin (${androidLink}).\n\nİkinci olarak, bu kişiselleştirilmiş davet bağlantısını Somus Uygulamasındaki \'Kayıt ol\' formuna yapıştırın: ${inviteLink}";

  static m51(username) => "@${username} kullanıcı adı ile katıldı";

  static m52(email) =>
      "${email} adresine gönderilen e-posta davetiyesi beklemede";

  static m53(maxLength) =>
      "Liste adı ${maxLength} karakterden daha uzun olamaz.";

  static m54(maxLength) =>
      "Biyografi kısmı ${maxLength} karakterden daha uzun olamaz.";

  static m55(maxLength) =>
      "Konum adı ${maxLength} karakterden daha uzun olamaz.";

  static m56(age) => "On Somus since ${age}";

  static m57(takenConnectionsCircleName) =>
      "Çevre adı \'${takenConnectionsCircleName}\' olarak alındı";
  ...
  static _notInlinedMessages(_) => <String, Function>{
        "application_settings__comment_sort_newest_first":
            MessageLookupByLibrary.simpleMessage("Önce en yeni"),
        "application_settings__comment_sort_oldest_first":
            MessageLookupByLibrary.simpleMessage("Önce en eski"),
        "application_settings__link_previews":
            MessageLookupByLibrary.simpleMessage("Bağlantı önizlemeleri"),
        ...
        "application_settings__link_previews_autoplay_never":
            MessageLookupByLibrary.simpleMessage("Asla"),
        "application_settings__link_previews_autoplay_wifi_only":
            MessageLookupByLibrary.simpleMessage("Yalnızca WiFi"),
        "application_settings__link_previews_show":
            MessageLookupByLibrary.simpleMessage("Göster"),
        "application_settings__tap_to_change":
            MessageLookupByLibrary.simpleMessage("(Değiştirmek için dokunun)"),
        "application_settings__videos":
            MessageLookupByLibrary.simpleMessage("Videolar"),
        "application_settings__videos_autoplay":
            MessageLookupByLibrary.simpleMessage("Otomatik Oynat"),
        ...
        "application_settings__videos_sound":
            MessageLookupByLibrary.simpleMessage("Ses"),
        "application_settings__videos_sound_disabled":
            MessageLookupByLibrary.simpleMessage("Devre Dışı"),
        "application_settings__videos_sound_enabled":
            MessageLookupByLibrary.simpleMessage("Etkin"),
        "auth__change_password_current_pwd":
            MessageLookupByLibrary.simpleMessage("Şimdiki şifreniz"),
        "auth__change_password_current_pwd_hint":
            MessageLookupByLibrary.simpleMessage("Geçerli şifrenizi giriniz"),
        "auth__change_password_current_pwd_incorrect":
            MessageLookupByLibrary.simpleMessage("Girilen şifre hatalı"),
        ...
        "auth__change_password_new_pwd_error": MessageLookupByLibrary.simpleMessage(
            "Lütfen şifrenizin 10 ila 100 karakter uzunluğunda olduğundan emin olun"),
        "auth__change_password_new_pwd_hint":
            MessageLookupByLibrary.simpleMessage("Yeni şifrenizi girin"),
        "auth__change_password_save_success":
            MessageLookupByLibrary.simpleMessage(
                "Hepsi iyi! şifreniz güncellendi"),
        ...
        "auth__create_acc__almost_there":
            MessageLookupByLibrary.simpleMessage("Neredeyse tamamlandı..."),
        "auth__create_acc__are_you_legal_age":
            MessageLookupByLibrary.simpleMessage("16 yaşından büyük müsünüz?"),
        "auth__create_acc__avatar_choose_camera":
            MessageLookupByLibrary.simpleMessage("Bir fotoğraf çekin"),
        "auth__create_acc__avatar_choose_gallery":
            MessageLookupByLibrary.simpleMessage("Mevcut bir fotoğrafı kullan"),
        ...
        "auth__create_acc__can_change_username":
            MessageLookupByLibrary.simpleMessage(
                "İsterseniz profil sayfanızdan istediğiniz zaman değiştirebilirsiniz."),
        ...
        "auth__create_acc__done_continue":
            MessageLookupByLibrary.simpleMessage("Oturum aç"),
        "auth__create_acc__done_created": MessageLookupByLibrary.simpleMessage(
            "Your account has been created."),
        "auth__create_acc__done_description":
            MessageLookupByLibrary.simpleMessage("Hesabınız oluşturuldu."),
        "auth__create_acc__done_subtext": MessageLookupByLibrary.simpleMessage(
            "Bunu profil ayarlarından değiştirebilirsin."),
        "auth__create_acc__done_title":
            MessageLookupByLibrary.simpleMessage("Yaşasın!"),
        "auth__create_acc__email_empty_error":
            MessageLookupByLibrary.simpleMessage(
                "😱 E-posta kısmı boş bırakılmaz"),
        "auth__create_acc__email_invalid_error":
            MessageLookupByLibrary.simpleMessage(
                "😅 Lütfen geçerli bir e-posta adresi girin."),
        "auth__create_acc__email_placeholder":
            MessageLookupByLibrary.simpleMessage("örnekpostaadresi@mail.com"),
        "auth__create_acc__email_server_error":
            MessageLookupByLibrary.simpleMessage(
                "😭 Sunucularımızla ilgili sorunlar yaşıyoruz, lütfen birkaç dakika içinde tekrar deneyin."),
        "auth__create_acc__email_taken_error":
            MessageLookupByLibrary.simpleMessage(
                "🤔 Bu e-postaya kayıtlı zaten bir hesap bulunuyor."),
        ...
        "auth__create_acc__link_empty_error":
            MessageLookupByLibrary.simpleMessage("Link boş bırakılamaz."),
        ...
        "auth__create_acc__name_characters_error":
            MessageLookupByLibrary.simpleMessage(
                "😅 Bir isim sadece alfanümerik karakterler içerebilir (şimdilik)."),
        "auth__create_acc__name_empty_error":
            MessageLookupByLibrary.simpleMessage(
                "😱 İsim kısmını boş bırakamazsın."),
        "auth__create_acc__name_length_error":
            MessageLookupByLibrary.simpleMessage(
                "😱 Adınız 50 karakterden uzun olamaz. (Öyle ise, çok üzgünüz.)"),
        "auth__create_acc__name_placeholder":
            MessageLookupByLibrary.simpleMessage("İsminizi Yazın"),
        "auth__create_acc__next": MessageLookupByLibrary.simpleMessage("İleri"),
        "auth__create_acc__one_last_thing":
            MessageLookupByLibrary.simpleMessage("Son bir şey..."),
        "auth__create_acc__password_empty_error":
            MessageLookupByLibrary.simpleMessage(
                "😱 Şifre kısmı boş bırakılamaz"),
        "auth__create_acc__password_length_error":
            MessageLookupByLibrary.simpleMessage(
                "😅 Bir şifre 8 ile 64 karakter arasında olmalıdır."),
        "auth__create_acc__paste_link": MessageLookupByLibrary.simpleMessage(
            "Kayıt bağlantınızı aşağıya yapıştırın"),
        "auth__create_acc__paste_link_help_text":
            MessageLookupByLibrary.simpleMessage(
                "Davet e-postanızdaki Openbook\'a Katıl düğmesini tıklayın."),
        "auth__create_acc__paste_password_reset_link":
            MessageLookupByLibrary.simpleMessage(
                "Şifre sıfırlama bağlantınızı aşağıya yapıştırın"),
        "auth__create_acc__previous":
            MessageLookupByLibrary.simpleMessage("Geri"),
        "auth__create_acc__register":
            MessageLookupByLibrary.simpleMessage("Kayıt Ol"),
        "auth__create_acc__request_invite":
            MessageLookupByLibrary.simpleMessage(
                "Davet yok mu? Buradan bir tane isteyin."),
        "auth__create_acc__submit_error_desc_server":
            MessageLookupByLibrary.simpleMessage(
                "😭 Sunucularımızla ilgili sorunlar yaşıyoruz, lütfen birkaç dakika içinde tekrar deneyin."),
        "auth__create_acc__submit_error_desc_validation":
            MessageLookupByLibrary.simpleMessage(
                "😅 Bazı bilgiler doğru değil gibi görünüyor, lütfen kontrol edin ve tekrar deneyin."),
        "auth__create_acc__submit_error_title":
            MessageLookupByLibrary.simpleMessage("Oh hayır..."),
        "auth__create_acc__submit_loading_desc":
            MessageLookupByLibrary.simpleMessage("Hesabınızı oluşturuyoruz."),
        "auth__create_acc__submit_loading_title":
            MessageLookupByLibrary.simpleMessage("Az kaldı!"),
        "auth__create_acc__subscribe":
            MessageLookupByLibrary.simpleMessage("Talep et"),
        "auth__create_acc__subscribe_to_waitlist_text":
            MessageLookupByLibrary.simpleMessage("Davet et!"),
        ...
        "auth__create_acc__username_characters_error":
            MessageLookupByLibrary.simpleMessage(
                "😅 Bir kullanıcı ismi yalnızca alfasayısal karakterler ve alt çizgiler içerebilir."),
        "auth__create_acc__username_empty_error":
            MessageLookupByLibrary.simpleMessage(
                "😱 Kullanıcı ismi boş bırakılamaz."),
        "auth__create_acc__username_length_error":
            MessageLookupByLibrary.simpleMessage(
                "😅 Bir kullanıcı ismi 30 karakterden uzun olamaz."),
        "auth__create_acc__username_placeholder":
            MessageLookupByLibrary.simpleMessage("nuribilgeceylan"),
        "auth__create_acc__username_server_error":
            MessageLookupByLibrary.simpleMessage(
                "😭 Sunucularımızla ilgili sorunlar yaşıyoruz, lütfen birkaç dakika içinde tekrar deneyin."),
        "auth__create_acc__username_taken_error":
            MessageLookupByLibrary.simpleMessage(
                "😩 @%s kullanıcı ismi daha önce alınmış."),
        "auth__create_acc__validating_token":
            MessageLookupByLibrary.simpleMessage("Validating token..."),
        "auth__create_acc__welcome_to_beta":
            MessageLookupByLibrary.simpleMessage("Betaya hoş geldiniz!"),
        "auth__create_acc__what_avatar":
            MessageLookupByLibrary.simpleMessage("Profil fotoğrafı seçin"),
        "auth__create_acc__what_email":
            MessageLookupByLibrary.simpleMessage("E-posta adresin nedir?"),
        "auth__create_acc__what_name":
            MessageLookupByLibrary.simpleMessage("İsminiz nedir?"),
        "auth__create_acc__what_password":
            MessageLookupByLibrary.simpleMessage("Bir parola seçin"),
        "auth__create_acc__what_password_subtext":
            MessageLookupByLibrary.simpleMessage("(en az 10 karakter)"),
        "auth__create_acc__what_username":
            MessageLookupByLibrary.simpleMessage("Bir kullanıcı adı seç"),
        "auth__create_acc__your_subscribed":
            MessageLookupByLibrary.simpleMessage("{0}. bekleme listesindesin."),
        ...
        "auth__create_account":
            MessageLookupByLibrary.simpleMessage("Kayıt ol"),
        "auth__description_empty_error":
            MessageLookupByLibrary.simpleMessage("Açıklama boş bırakılmaz."),
        "auth__description_range_error": m1,
        "auth__email_empty_error":
            MessageLookupByLibrary.simpleMessage("E-posta boş bırakılamaz."),
        "auth__email_invalid_error": MessageLookupByLibrary.simpleMessage(
            "Lütfen geçerli bir e-posta adresi girin."),
        "auth__headline":
            MessageLookupByLibrary.simpleMessage("Daha iyi bir sosyal ağ."),
        ...
        "auth__login__connection_error": MessageLookupByLibrary.simpleMessage(
            "Sunucularımıza ulaşamıyoruz. İnternete bağlı mısınız?"),
        "auth__login__credentials_mismatch_error":
            MessageLookupByLibrary.simpleMessage(
                "Verdiğiniz kimlik bilgileri uyuşmuyor."),
        ...
        "auth__login__server_error": MessageLookupByLibrary.simpleMessage(
            "Ah.. Sunucu sorunları yaşıyoruz. Lütfen birkaç dakika içinde tekrar deneyin."),
        "auth__login__subtitle": MessageLookupByLibrary.simpleMessage(
            "Devam etmek için kimlik bilgilerinizi girin."),
        "auth__login__title":
            MessageLookupByLibrary.simpleMessage("Tekrar Hoşgeldin!"),
        "auth__login__username_characters_error":
            MessageLookupByLibrary.simpleMessage(
                "Kullanıcı adı yalnızca alfasayısal karakterler ve alt çizgiler içerebilir."),
        ...
        "auth__password_empty_error":
            MessageLookupByLibrary.simpleMessage("Parola boş bırakılamaz."),
        "auth__password_range_error": m3,
        "auth__reset_password_success_info":
            MessageLookupByLibrary.simpleMessage(
                "Şifreniz başarıyla güncellendi"),
        "auth__reset_password_success_title":
            MessageLookupByLibrary.simpleMessage("Her şey tamam!"),
        "auth__username_characters_error": MessageLookupByLibrary.simpleMessage(
            "Bir kullanıcı adı yalnızca alfasayısal karakterler ve alt çizgiler içerebilir."),
        ...
        "community__actions_invite_people_title":
            MessageLookupByLibrary.simpleMessage(
                "İnsanları topluluğa davet et"),
        "community__actions_manage_text":
            MessageLookupByLibrary.simpleMessage("Yönet"),
        "community__add_administrators_title":
            MessageLookupByLibrary.simpleMessage("Yönetici ekle."),
        ...
        "community__button_staff":
            MessageLookupByLibrary.simpleMessage("Personel"),
        ...
        "community__communities_no_category_found":
            MessageLookupByLibrary.simpleMessage(
                "Kategori bulunamadı. Lütfen birkaç dakika içinde tekrar deneyin."),
        ...
        "community__community":
            MessageLookupByLibrary.simpleMessage("topluluk"),
        "community__community_members":
            MessageLookupByLibrary.simpleMessage("Topluluk üyeleri"),
        "community__community_staff":
            MessageLookupByLibrary.simpleMessage("Topluluk kadrosu"),
        "community__confirmation_title":
            MessageLookupByLibrary.simpleMessage("Onay"),
        "community__delete_confirmation": MessageLookupByLibrary.simpleMessage(
            "Topluluğu silmek istediğinden emin misin?"),
        "community__delete_desc": MessageLookupByLibrary.simpleMessage(
            "Bu zaman çizelgesinde mesajları göremezsiniz ya da artık yayınlamak mümkün değildir."),
        ...
        "community__invite_to_community_resource_plural":
            MessageLookupByLibrary.simpleMessage("bağlantılar ve takipçiler"),
        "community__invite_to_community_resource_singular":
            MessageLookupByLibrary.simpleMessage("bağlantı veya takipçi"),
        "community__invite_to_community_title":
            MessageLookupByLibrary.simpleMessage("Topluluğa davet et"),
        "community__invited_by_member": MessageLookupByLibrary.simpleMessage(
            "Bir üye tarafından davet edilmelisin."),
        "community__invited_by_moderator": MessageLookupByLibrary.simpleMessage(
            "Bir moderatör tarafından davet edilmen gerekiyor."),
        ...
        "community__join_community":
            MessageLookupByLibrary.simpleMessage("Katıl"),
        ...
        "community__manage_invite_desc": MessageLookupByLibrary.simpleMessage(
            "Bağlantılarınızı ve takipçilerinizi topluluğa katılmaya davet edin."),
        "community__manage_invite_title":
            MessageLookupByLibrary.simpleMessage("İnsanları davet et"),
        "community__manage_leave_desc":
            MessageLookupByLibrary.simpleMessage("Topluluktan ayrıl."),
        "community__manage_leave_title":
            MessageLookupByLibrary.simpleMessage("Topluluktan ayrıl"),
        "community__manage_mod_reports_desc":
            MessageLookupByLibrary.simpleMessage(
                "Topluluk denetim raporlarını gözden geçirin."),
        "community__manage_mod_reports_title":
            MessageLookupByLibrary.simpleMessage("Denetim raporları"),
        "community__manage_mods_desc": MessageLookupByLibrary.simpleMessage(
            "Moderatörleri görün, ekleyin ve kaldırın."),
        "community__manage_mods_title":
            MessageLookupByLibrary.simpleMessage("Moderatörler"),
        "community__manage_remove_favourite":
            MessageLookupByLibrary.simpleMessage(
                "Topluluğu favorilerinizden kaldırın"),
        "community__manage_title":
            MessageLookupByLibrary.simpleMessage("Topluluğu yönet"),
        "community__member": MessageLookupByLibrary.simpleMessage("üye"),
        "community__member_capitalized":
            MessageLookupByLibrary.simpleMessage("Üye"),
        ...
        "community__moderator_desc": MessageLookupByLibrary.simpleMessage(
            "Bu, üyenin topluluk ayrıntılarını, moderatörleri ve engelli kullanıcıları düzenlemesini sağlar."),
        "community__moderator_resource_name":
            MessageLookupByLibrary.simpleMessage("moderatör"),
        ...
        "community__name_characters_error": MessageLookupByLibrary.simpleMessage(
            "İsim yalnızca alfasayısal karakterler ve alt çizgiler içerebilir."),
        ...
        "community__post_plural":
            MessageLookupByLibrary.simpleMessage("gönderiler"),
        "community__post_singular":
            MessageLookupByLibrary.simpleMessage("gönderi"),
        "community__posts": MessageLookupByLibrary.simpleMessage("Gönderiler"),
        "community__refresh_text":
            MessageLookupByLibrary.simpleMessage("Yenile"),
        "community__refreshing":
            MessageLookupByLibrary.simpleMessage("Ferahlatıcı topluluk"),
        "community__retry_loading_posts":
            MessageLookupByLibrary.simpleMessage("Tekrar denemek için dokunun"),
        "community__rules_empty_error": MessageLookupByLibrary.simpleMessage(
            "Kurallar bölümü boş bırakılmaz."),
        ...
        "community__save_community_name_title_hint_text":
            MessageLookupByLibrary.simpleMessage(
                " örneğin. Seyahat, Fotoğrafçılık, Oyun."),
        ...
        "contextual_account_search_box__suggestions":
            MessageLookupByLibrary.simpleMessage("Öneriler"),
        ...
        "drawer__account_settings_blocked_users":
            MessageLookupByLibrary.simpleMessage("Engellenmiş kullanıcılar"),
        "drawer__account_settings_change_email":
            MessageLookupByLibrary.simpleMessage("E-Postanı Değiştir"),
        "drawer__account_settings_change_password":
            MessageLookupByLibrary.simpleMessage("Şifreni Değiştir"),
        ...
        "drawer__app_account_text":
            MessageLookupByLibrary.simpleMessage("Uygulama ve Hesap"),
        "drawer__application_settings":
            MessageLookupByLibrary.simpleMessage("Uygulama Ayarları"),
        "drawer__connections":
            MessageLookupByLibrary.simpleMessage("Bağlantılarım"),
        "drawer__customize":
            MessageLookupByLibrary.simpleMessage("Kişiselleştir"),
        "drawer__developer_settings":
            MessageLookupByLibrary.simpleMessage("Geliştirici Ayarları"),
        "drawer__global_moderation":
            MessageLookupByLibrary.simpleMessage("Global denetim"),
        "drawer__help":
            MessageLookupByLibrary.simpleMessage("Destek ve Geri Bildirim"),
        ...
        "drawer__useful_links_guidelines":
            MessageLookupByLibrary.simpleMessage("Somus\'nın ilkeleri"),
        "drawer__useful_links_guidelines_bug_tracker":
            MessageLookupByLibrary.simpleMessage("Hata izleyici"),
        "drawer__useful_links_guidelines_bug_tracker_desc":
            MessageLookupByLibrary.simpleMessage(
                "Bir hata rapor edin veya var olan hataları oylayın"),
        "drawer__useful_links_guidelines_desc":
            MessageLookupByLibrary.simpleMessage(
                "Hepinizin sağlıklı ve dostça bir ortak varlığınızı korumak için izlemeniz gereken kurallar."),
        "drawer__useful_links_guidelines_feature_requests":
            MessageLookupByLibrary.simpleMessage("Özellik istekleri"),
        "drawer__useful_links_guidelines_feature_requests_desc":
            MessageLookupByLibrary.simpleMessage(
                "Bir özellik isteyin veya var olan istekleri oylayın"),
        "drawer__useful_links_guidelines_github":
            MessageLookupByLibrary.simpleMessage("Github proje panosu"),
        "drawer__useful_links_guidelines_github_desc":
            MessageLookupByLibrary.simpleMessage(
                "Şu anda üzerinde çalıştığımıza bir göz atın"),
        "drawer__useful_links_guidelines_handbook":
            MessageLookupByLibrary.simpleMessage("Somus el kitabı"),
        "drawer__useful_links_guidelines_handbook_desc":
            MessageLookupByLibrary.simpleMessage(
                "Platformu kullanma hakkında bilmeniz gereken her şeyi içeren bir kitap"),
        "drawer__useful_links_slack_channel":
            MessageLookupByLibrary.simpleMessage("Topluluk çözüm kanalı"),
        "drawer__useful_links_slack_channel_desc":
            MessageLookupByLibrary.simpleMessage(
                "Somus hakkında her şeyi tartışacağınız bir yer"),
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Somus Destek"),
        "drawer__useful_links_support_desc":
            MessageLookupByLibrary.simpleMessage(
                "Yolculuğumuzda bizi destekleyebilecek bir yönteme bakın!"),
        ...
        "image_picker__from_camera":
            MessageLookupByLibrary.simpleMessage("Kameradan"),
        "image_picker__from_gallery":
            MessageLookupByLibrary.simpleMessage("Galeriden"),
        "media_service__crop_image":
            MessageLookupByLibrary.simpleMessage("Crop image"),
        "moderation__actions_chat_with_team":
            MessageLookupByLibrary.simpleMessage("Ekiple sohbet et"),
        "moderation__actions_review":
            MessageLookupByLibrary.simpleMessage("Detaylı"),
        "moderation__category_text":
            MessageLookupByLibrary.simpleMessage("Kategori"),
        "moderation__community_moderated_objects":
            MessageLookupByLibrary.simpleMessage(
                "Toplulukta denetlenen nesneler"),
        "moderation__community_review_approve":
            MessageLookupByLibrary.simpleMessage("Onaylandı"),
        "moderation__community_review_item_verified":
            MessageLookupByLibrary.simpleMessage("Bu madde doğrulandı"),
        "moderation__community_review_object":
            MessageLookupByLibrary.simpleMessage("Nesne"),
        "moderation__community_review_reject":
            MessageLookupByLibrary.simpleMessage("reddedildi"),
        "moderation__community_review_title":
            MessageLookupByLibrary.simpleMessage(
                "Yönetilen nesneyi gözden geçir"),
        "moderation__confirm_report_community_reported":
            MessageLookupByLibrary.simpleMessage("Topluluk bildirildi"),
        "moderation__confirm_report_item_reported":
            MessageLookupByLibrary.simpleMessage("Öğe bildirildi"),
        "moderation__confirm_report_post_comment_reported":
            MessageLookupByLibrary.simpleMessage(
                "Gönderideki yorum bildirildi"),
        "moderation__confirm_report_post_reported":
            MessageLookupByLibrary.simpleMessage("Gönderi bildirildi"),
        "moderation__confirm_report_provide_details":
            MessageLookupByLibrary.simpleMessage(
                "Raporla alakalı olabilecek ilave detaylar verebilir misiniz?"),
        ...
        "moderation__confirm_report_submit":
            MessageLookupByLibrary.simpleMessage("Anladım, gönder."),
        "moderation__confirm_report_title":
            MessageLookupByLibrary.simpleMessage("Rapor gönder"),
        "moderation__confirm_report_user_reported":
            MessageLookupByLibrary.simpleMessage("Kullanıcı bildirildi"),
        ...
        "moderation__filters_reset":
            MessageLookupByLibrary.simpleMessage("Sıfırla"),
        "moderation__filters_status":
            MessageLookupByLibrary.simpleMessage("Durum"),
        "moderation__filters_title":
            MessageLookupByLibrary.simpleMessage("Moderasyon Filtreleri"),
        "moderation__filters_type": MessageLookupByLibrary.simpleMessage("Tür"),
        "moderation__filters_verified":
            MessageLookupByLibrary.simpleMessage("Doğrulandı"),
        ...
        "moderation__pending_moderation_tasks_singular":
            MessageLookupByLibrary.simpleMessage("bekleyen moderasyon görevi"),
        "moderation__report_account_text":
            MessageLookupByLibrary.simpleMessage("Hesabı bildir"),
        "moderation__report_comment_text":
            MessageLookupByLibrary.simpleMessage("Yorumu bildir"),
        "moderation__report_community_text":
            MessageLookupByLibrary.simpleMessage("Topluluğu bildir"),
        "moderation__report_hashtag_text":
            MessageLookupByLibrary.simpleMessage("Report hashtag"),
        "moderation__report_post_text":
            MessageLookupByLibrary.simpleMessage("Gönderiyi bildir"),
        "moderation__reporter_text":
            MessageLookupByLibrary.simpleMessage("Raporlayıcı"),
        "moderation__reports_preview_resource_reports":
            MessageLookupByLibrary.simpleMessage("raporlar"),
        ...
        "notifications__comment_desc": MessageLookupByLibrary.simpleMessage(
            "Birisi gönderilerinizden biriyle veya bir yorumunuzla ilgili yorum yazdığında haberdar olun."),
        "notifications__comment_reaction_desc":
            MessageLookupByLibrary.simpleMessage(
                "Birisi yorumlarınızdan birine reaksiyon verdiğinde haberdar olun"),
        "notifications__comment_reaction_title":
            MessageLookupByLibrary.simpleMessage(
                "Gönderi yorumundaki reaksiyon"),
        "notifications__comment_reply_desc": MessageLookupByLibrary.simpleMessage(
            "Birisi yorumlarınızdan birini veya cevapladığınız birini cevapladığında haberdar olun"),
        ...
        "notifications__comment_reply_title":
            MessageLookupByLibrary.simpleMessage("Gönderideki yorum cevabı"),
        "notifications__comment_title":
            MessageLookupByLibrary.simpleMessage("Gönderi yorumu"),
        "notifications__comment_user_mention_desc":
            MessageLookupByLibrary.simpleMessage(
                "Birisi sizden yorumlarından birinde bahsettiğinde haberdar olun"),
        "notifications__comment_user_mention_title":
            MessageLookupByLibrary.simpleMessage(
                "Gönderi yorumunda bahsedilmesi"),
        "notifications__community_invite_desc":
            MessageLookupByLibrary.simpleMessage(
                "Birisi sizi bir topluluğa katılmaya davet ettiğinde haberdar olun."),
        ...
        "notifications__mute_post_turn_on_post_comment_notifications":
            MessageLookupByLibrary.simpleMessage(
                "Gönderi yorumlarının bildirimlerini aç"),
        "notifications__mute_post_turn_on_post_notifications":
            MessageLookupByLibrary.simpleMessage("Gönderi bildirimlerini aç"),
        "notifications__post_reaction_desc":
            MessageLookupByLibrary.simpleMessage(
                "Birisi gönderinize yanıt verdiğinde haberdar olun."),
        "notifications__post_reaction_title":
            MessageLookupByLibrary.simpleMessage("Gönderi reaksiyonu"),
        "notifications__post_user_mention_desc":
            MessageLookupByLibrary.simpleMessage(
                "Birisi gönderilerinden birinde sizden bahsettiğinde haberdar olun"),
        "notifications__post_user_mention_title":
            MessageLookupByLibrary.simpleMessage("Gönderide bahsedilmesi"),
        "notifications__reacted_to_post_comment_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] yorumunuza reaksiyon verdi."),
        "notifications__reacted_to_post_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] gönderinize yanıt verdi."),
        ...
        "notifications__tab_requests":
            MessageLookupByLibrary.simpleMessage("İstekler"),
        ...
        "post__actions_comment_deleted":
            MessageLookupByLibrary.simpleMessage("Yorum silindi"),
        "post__actions_delete":
            MessageLookupByLibrary.simpleMessage("Gönderiyi sil"),
        "post__actions_delete_comment":
            MessageLookupByLibrary.simpleMessage("Yorumu sil"),
        ...
        "post__actions_deleted":
            MessageLookupByLibrary.simpleMessage("Gönderi silindi"),
        "post__actions_edit_comment":
            MessageLookupByLibrary.simpleMessage("Yorumu düzenle"),
        "post__actions_report_text":
            MessageLookupByLibrary.simpleMessage("Bildir"),
        "post__actions_reported_text":
            MessageLookupByLibrary.simpleMessage("Bildirildi"),
        ...
        "post__close_create_post_label": MessageLookupByLibrary.simpleMessage(
            "Yeni gönderi oluştur\'u kapat"),
        "post__close_post":
            MessageLookupByLibrary.simpleMessage("Gönderiyi kapat"),
        "post__comment_maxlength_error": m30,
        "post__comment_reply_expanded_post":
            MessageLookupByLibrary.simpleMessage("Gönderi"),
        "post__comment_reply_expanded_reply_comment":
            MessageLookupByLibrary.simpleMessage("Yorumu cevapla"),
        "post__comment_reply_expanded_reply_hint_text":
            MessageLookupByLibrary.simpleMessage("Cevabınız..."),
        ...
        "post__commenter_expanded_join_conversation":
            MessageLookupByLibrary.simpleMessage("Sohbete katıl.."),
        "post__commenter_expanded_save":
            MessageLookupByLibrary.simpleMessage("Kaydet"),
        "post__commenter_expanded_start_conversation":
            MessageLookupByLibrary.simpleMessage("Sohbeti başlat.."),
        "post__commenter_post_text":
            MessageLookupByLibrary.simpleMessage("Gönderi"),
        "post__commenter_write_something":
            MessageLookupByLibrary.simpleMessage("Bir şey yaz..."),
        "post__comments_closed_post":
            MessageLookupByLibrary.simpleMessage("Gönderi kapatıldı"),
        "post__comments_disabled":
            MessageLookupByLibrary.simpleMessage("Yorumlar devre dışı"),
        "post__comments_disabled_message": MessageLookupByLibrary.simpleMessage(
            "Gönderi için yorumlar devre dışı"),
        "post__comments_enabled_message":
            MessageLookupByLibrary.simpleMessage("Gönderi için yorumlar etkin"),
        "post__comments_header_be_the_first_comments":
            MessageLookupByLibrary.simpleMessage("İlk yorumu siz yapın"),
        "post__comments_header_be_the_first_replies":
            MessageLookupByLibrary.simpleMessage("İlk cevaplayan siz olun"),
        "post__comments_header_newer":
            MessageLookupByLibrary.simpleMessage("Daha yeni"),
        "post__comments_header_newest_comments":
            MessageLookupByLibrary.simpleMessage("En yeni yorumlar"),
        "post__comments_header_newest_replies":
            MessageLookupByLibrary.simpleMessage("En yeni cevaplar"),
        "post__comments_header_older":
            MessageLookupByLibrary.simpleMessage("Daha eski"),
        "post__comments_header_oldest_comments":
            MessageLookupByLibrary.simpleMessage("En eski yorumlar"),
        "post__comments_header_oldest_replies":
            MessageLookupByLibrary.simpleMessage("En eski cevaplar"),
        "post__comments_header_see_newest_comments":
            MessageLookupByLibrary.simpleMessage("En yeni yorumları görün"),
        "post__comments_header_see_newest_replies":
            MessageLookupByLibrary.simpleMessage("En yeni cevaplara bakın"),
        "post__comments_header_see_oldest_comments":
            MessageLookupByLibrary.simpleMessage("En eski yorumları görün"),
        "post__comments_header_see_oldest_replies":
            MessageLookupByLibrary.simpleMessage("En eski cevaplara bakın"),
        "post__comments_header_view_newest_comments":
            MessageLookupByLibrary.simpleMessage("En yeni yorumları görüntüle"),
        "post__comments_header_view_newest_replies":
            MessageLookupByLibrary.simpleMessage("En yeni cevapları görüntüle"),
        "post__comments_header_view_oldest_comments":
            MessageLookupByLibrary.simpleMessage("En eski yorumları görüntüle"),
        "post__comments_header_view_oldest_replies":
            MessageLookupByLibrary.simpleMessage("En eski cevapları görüntüle"),
        "post__comments_page_no_more_replies_to_load":
            MessageLookupByLibrary.simpleMessage("Yüklenecek cevap yok"),
        "post__comments_page_no_more_to_load":
            MessageLookupByLibrary.simpleMessage("Yüklenecek yorum yok"),
        "post__comments_page_replies_title":
            MessageLookupByLibrary.simpleMessage("Cevap yaz"),
        "post__comments_page_tap_to_retry":
            MessageLookupByLibrary.simpleMessage(
                "Yorumları yüklemeyi yeniden denemek için dokunun."),
        "post__comments_page_tap_to_retry_replies":
            MessageLookupByLibrary.simpleMessage(
                "Cevapları tekrar yüklemek için dokunun."),
        "post__comments_page_title":
            MessageLookupByLibrary.simpleMessage("Gönderi yorumları"),
        "post__comments_view_all_comments": m31,
        "post__create_hashtags_invalid": m32,
        "post__create_new":
            MessageLookupByLibrary.simpleMessage("Yeni gönderi"),
        ...
        "post__disable_post_comments": MessageLookupByLibrary.simpleMessage(
            "Yorum gönderilmesini devre dışı bırakın"),
        ...
        "post__my_circles_desc": MessageLookupByLibrary.simpleMessage(
            "Gönderiyi çevrelerinizden birine veya çoğunluğa paylaşın."),
        "post__no_circles_for": m33,
        "post__open_post": MessageLookupByLibrary.simpleMessage("Gönderiyi aç"),
        "post__post_closed":
            MessageLookupByLibrary.simpleMessage("Gönderi kapatıldı "),
        "post__post_opened":
            MessageLookupByLibrary.simpleMessage("Gönderi açıldı"),
        "post__post_reactions_title":
            MessageLookupByLibrary.simpleMessage("Gönderi reaksiyonları"),
        "post__profile_counts_follower":
            MessageLookupByLibrary.simpleMessage(" Takipçi"),
        "post__profile_counts_followers":
            MessageLookupByLibrary.simpleMessage(" Takipçiler"),
        "post__profile_counts_following":
            MessageLookupByLibrary.simpleMessage(" Takip edilen"),
        ...
        "post__reaction_list_tap_retry": MessageLookupByLibrary.simpleMessage(
            "Reaksiyonları tekrar yüklemek için dokunun."),
        ...
        "post__share_community_title":
            MessageLookupByLibrary.simpleMessage("Bir toplulukta"),
        ...
        "post__sharing_post_to":
            MessageLookupByLibrary.simpleMessage("Gönderinin paylaşılması"),
        "post__text_copied":
            MessageLookupByLibrary.simpleMessage("Metin kopyalandı!"),
        ...
        "post__time_short_now_text":
            MessageLookupByLibrary.simpleMessage("şimdi"),
        ...
        "post__time_short_one_minute":
            MessageLookupByLibrary.simpleMessage("1d"),
        ...
        "post__timeline_posts_all_loaded":
            MessageLookupByLibrary.simpleMessage("🎉 Tüm gönderiler yüklendi"),
        "post__timeline_posts_default_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "Zaman Tünelini yenilemeyi deneyin."),
        "post__timeline_posts_default_drhoo_title":
            MessageLookupByLibrary.simpleMessage("Bir şeyler doğru değil."),
        "post__timeline_posts_failed_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "Birkaç saniye sonra tekrar deneyin"),
        "post__timeline_posts_failed_drhoo_title":
            MessageLookupByLibrary.simpleMessage(
                "Zaman Tüneliniz yüklenemedi."),
        "post__timeline_posts_no_more_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "Başlamak için kullanıcıları takip edin veya bir topluluğa katılın!"),
        "post__timeline_posts_refresh_posts":
            MessageLookupByLibrary.simpleMessage("Gönderileri yenile"),
        ...
        "post__trending_posts_no_trending_posts":
            MessageLookupByLibrary.simpleMessage(
                "Popüler gönderiler yok. Birkaç saniye içinde yenilemeyi deneyin."),
        ...
        "post__world_circle_name":
            MessageLookupByLibrary.simpleMessage("Dünya"),
        "post__you_shared_with":
            MessageLookupByLibrary.simpleMessage("İle paylaştı"),
        "post_body_link_preview__empty":
            MessageLookupByLibrary.simpleMessage("Bu bağlantı önizlenemedi"),
        "post_body_link_preview__error_with_description": m36,
        "post_body_media__unsupported":
            MessageLookupByLibrary.simpleMessage("Desteklenmeyen medya türü"),
        "post_uploader__cancelled":
            MessageLookupByLibrary.simpleMessage("İptal edildi!"),
        "post_uploader__cancelling":
            MessageLookupByLibrary.simpleMessage("İptal ediliyor"),
        "post_uploader__compressing_media":
            MessageLookupByLibrary.simpleMessage("Medya sıkıştırılıyor..."),
        "post_uploader__creating_post":
            MessageLookupByLibrary.simpleMessage("Gönderi oluşturuluyor..."),
        "post_uploader__generic_upload_failed":
            MessageLookupByLibrary.simpleMessage("Gönderme başarısız oldu"),
        "post_uploader__processing":
            MessageLookupByLibrary.simpleMessage("Gönderi işleniyor..."),
        "post_uploader__publishing":
            MessageLookupByLibrary.simpleMessage("Gönderi yayınlanıyor..."),
        "post_uploader__success":
            MessageLookupByLibrary.simpleMessage("Başarılı!"),
        "post_uploader__uploading_media":
            MessageLookupByLibrary.simpleMessage("Medya yükleniyor..."),
        "posts_stream__all_loaded":
            MessageLookupByLibrary.simpleMessage("🎉 Tüm gönderiler yüklendi"),
        "posts_stream__empty_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "Birkaç saniye içinde yeniden deneyin."),
        "posts_stream__empty_drhoo_title":
            MessageLookupByLibrary.simpleMessage("Bu akışta bir şey yok."),
        "posts_stream__failed_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "Birkaç saniye sonra tekrar deneyin"),
        "posts_stream__failed_drhoo_title":
            MessageLookupByLibrary.simpleMessage("Akış yüklenemedi."),
        "posts_stream__refreshing_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage("Akış yenileniyor."),
        "posts_stream__refreshing_drhoo_title":
            MessageLookupByLibrary.simpleMessage("Az kaldı!"),
        "posts_stream__status_tile_empty":
            MessageLookupByLibrary.simpleMessage("Hiç gönderi bulunamadı"),
        ...
        "user__add_account_to_lists":
            MessageLookupByLibrary.simpleMessage("Listeye hesap ekle"),
        "user__add_account_update_account_lists":
            MessageLookupByLibrary.simpleMessage("Hesap listelerini güncelle"),
        "user__add_account_update_lists":
            MessageLookupByLibrary.simpleMessage("Listeleri güncelle"),
        ...
        "user__change_email_error":
            MessageLookupByLibrary.simpleMessage("Bu E-posta zaten kayıtlı"),
        "user__change_email_hint_text": MessageLookupByLibrary.simpleMessage(
            "Yeni E-posta adresinizi giriniz"),
        "user__change_email_save":
            MessageLookupByLibrary.simpleMessage("Kaydet"),
        "user__change_email_success_info": MessageLookupByLibrary.simpleMessage(
            "Yeni e-posta adresinize bir onay linki gönderdik, yeni e-postanızı doğrulamak için tıklayın"),
        "user__change_email_title":
            MessageLookupByLibrary.simpleMessage("E-postanı değiştir"),
        "user__circle_name_empty_error":
            MessageLookupByLibrary.simpleMessage("Çevre adı boş bırakılmaz."),
        "user__circle_name_range_error": m37,
        "user__circle_peoples_count": m38,
        "user__clear_app_preferences_cleared_successfully":
            MessageLookupByLibrary.simpleMessage(
                "Tercihler başarıyla temizlendi"),
        "user__clear_app_preferences_desc": MessageLookupByLibrary.simpleMessage(
            "Uygulama tercihlerini temizleyin. Şu anda bu sadece tercih edilen yorumların sırası için geçerlidir."),
        "user__clear_app_preferences_error":
            MessageLookupByLibrary.simpleMessage("Tercihler temizlenemedi"),
        "user__clear_app_preferences_title":
            MessageLookupByLibrary.simpleMessage("Tercihleri temizle"),
        "user__clear_application_cache_desc": MessageLookupByLibrary.simpleMessage(
            "Önbelleğe alınmış gönderileri, hesapları, resimleri ve daha fazlasını temizleyin."),
        "user__clear_application_cache_failure":
            MessageLookupByLibrary.simpleMessage("Önbellek temizlenemedi"),
        ...
        "user__confirm_block_user_info": MessageLookupByLibrary.simpleMessage(
            "Birbiriniz ile hiçbir paylaşımda bulunamazsınız ve hiçbir şekilde etkileşime giremezsiniz."),
        "user__confirm_block_user_no":
            MessageLookupByLibrary.simpleMessage("Hayır"),
        "user__confirm_block_user_question": m39,
        "user__confirm_block_user_title":
            MessageLookupByLibrary.simpleMessage("Onay"),
        "user__confirm_block_user_yes":
            MessageLookupByLibrary.simpleMessage("Evet"),
        "user__confirm_connection_add_connection":
            MessageLookupByLibrary.simpleMessage("Çevrene bağlantı ekle"),
        "user__confirm_connection_confirm_text":
            MessageLookupByLibrary.simpleMessage("Onayla"),
        ...
        "user__confirm_guidelines_reject_go_back":
            MessageLookupByLibrary.simpleMessage("Geri dön"),
        "user__confirm_guidelines_reject_info":
            MessageLookupByLibrary.simpleMessage(
                "Kuralları kabul edene kadar Somus\'yı kullanamazsınız."),
        "user__confirm_guidelines_reject_join_slack":
            MessageLookupByLibrary.simpleMessage("Çözüm kanalına katılın."),
        "user__confirm_guidelines_reject_title":
            MessageLookupByLibrary.simpleMessage("Kurallar Redded"),
        ...
        "user__delete_account_current_pwd_hint":
            MessageLookupByLibrary.simpleMessage("Mevcut şifrenizi giriniz"),
        ...
        "user__disconnect_from_user_success":
            MessageLookupByLibrary.simpleMessage("Bağlantı başarıyla kesildi"),
        "user__edit_profile_bio":
            MessageLookupByLibrary.simpleMessage("Biyografi"),
        "user__edit_profile_community_posts":
            MessageLookupByLibrary.simpleMessage("Topluluk gönderileri"),
        ...
        "user__edit_profile_pick_image":
            MessageLookupByLibrary.simpleMessage("Resim seç"),
        ...
        "user__email_verification_error": MessageLookupByLibrary.simpleMessage(
            "Oops! Belirteciniz geçerli veya süresi doldu, lütfen yeniden deneyin"),
        "user__email_verification_successful":
            MessageLookupByLibrary.simpleMessage(
                "Harika! E-postanız şimdi doğrulandı"),
        "user__emoji_field_none_selected":
            MessageLookupByLibrary.simpleMessage("Emoji seçilmedi"),
        ...
        "user__follow_button_unfollow_text":
            MessageLookupByLibrary.simpleMessage("Takip etmekten vazgeç"),
        "user__follow_lists_no_list_found":
            MessageLookupByLibrary.simpleMessage("Hiç liste bulunmadı."),
        "user__follow_lists_no_list_found_for": m46,
        "user__follow_lists_search_for":
            MessageLookupByLibrary.simpleMessage("Liste ara..."),
        "user__follow_lists_title":
            MessageLookupByLibrary.simpleMessage("Listelerim"),
        ...
        "user__following_resource_name":
            MessageLookupByLibrary.simpleMessage("takip edilen kullanıcılar"),
        ...
        "user__follows_lists_account":
            MessageLookupByLibrary.simpleMessage("1 Hesap"),
        "user__follows_lists_accounts": m48,
        "user__groups_see_all": m49,
        "user__guidelines_accept":
            MessageLookupByLibrary.simpleMessage("Kabul et"),
        "user__guidelines_desc": MessageLookupByLibrary.simpleMessage(
            "Lütfen kurallarımızı okumak ve kabul etmek için bir dakikanızı ayırın."),
        "user__guidelines_reject":
            MessageLookupByLibrary.simpleMessage("Reddet"),
        ...
        "user__invites_accepted_group_item_name":
            MessageLookupByLibrary.simpleMessage("kabul edilen davet"),
        "user__invites_accepted_group_name":
            MessageLookupByLibrary.simpleMessage("kabul edilen davetler"),
        "user__invites_accepted_title":
            MessageLookupByLibrary.simpleMessage("Kabul edilen"),
        "user__invites_create_create":
            MessageLookupByLibrary.simpleMessage("Oluştur"),
        "user__invites_create_create_title":
            MessageLookupByLibrary.simpleMessage("Davet oluştur"),
        "user__invites_create_edit_title":
            MessageLookupByLibrary.simpleMessage("Davetiyeyi düzenle"),
        "user__invites_create_name_hint":
            MessageLookupByLibrary.simpleMessage("örneğin Ali Ayşe"),
        ...
        "user__invites_email_hint":
            MessageLookupByLibrary.simpleMessage("örneğin epostanız@email.com"),
        "user__invites_email_invite_text":
            MessageLookupByLibrary.simpleMessage("E-posta ile davet et"),
        "user__invites_email_send_text":
            MessageLookupByLibrary.simpleMessage("Gönder"),
        "user__invites_email_sent_text":
            MessageLookupByLibrary.simpleMessage("E-posta ile davet gönder"),
        "user__invites_email_text":
            MessageLookupByLibrary.simpleMessage("E-posta"),
        "user__invites_invite_a_friend":
            MessageLookupByLibrary.simpleMessage("Bir arkadaşını davet et"),
        "user__invites_invite_text":
            MessageLookupByLibrary.simpleMessage("Davet et"),
        "user__invites_joined_with": m51,
        "user__invites_none_left":
            MessageLookupByLibrary.simpleMessage("Hiç davetiniz yok."),
        "user__invites_none_used": MessageLookupByLibrary.simpleMessage(
            "Görünüşe göre hiç davet etmeyi kullanmadın."),
        ...
        "user__invites_pending_group_item_name":
            MessageLookupByLibrary.simpleMessage("bekleyen davet"),
        "user__invites_pending_group_name":
            MessageLookupByLibrary.simpleMessage("bekleyen davetler"),
        ...
        "user__invites_share_email": MessageLookupByLibrary.simpleMessage(
            "Davetiyeyi e-posta ile paylaş"),
        "user__invites_share_email_desc": MessageLookupByLibrary.simpleMessage(
            "Sizin adınıza talimatlar içeren bir davetiye e-postası göndereceğiz"),
        "user__invites_share_yourself":
            MessageLookupByLibrary.simpleMessage("Kendinize daveti paylaşın"),
        "user__invites_share_yourself_desc":
            MessageLookupByLibrary.simpleMessage(
                "Mesajlaşma uygulamaları ve benzerleri arasından seçim yapın."),
        "user__invites_title":
            MessageLookupByLibrary.simpleMessage("Davet ettiklerim"),
        ...
        "user__list_name_empty_error":
            MessageLookupByLibrary.simpleMessage("Liste adı boş olamaz."),
        ...
        "user__profile_action_cancel_connection":
            MessageLookupByLibrary.simpleMessage("Bağlantı isteğini iptal et"),
        "user__profile_action_deny_connection":
            MessageLookupByLibrary.simpleMessage("Bağlantı isteğini reddet"),
        ...
        "user__profile_url_invalid_error": MessageLookupByLibrary.simpleMessage(
            "Lütfen geçerli bir url adresi girin."),
        "user__remove_account_from_list":
            MessageLookupByLibrary.simpleMessage("Hesabı listelerden kaldır"),
        ...
        "user__save_connection_circle_create":
            MessageLookupByLibrary.simpleMessage("Çevre oluştur"),
        "user__save_connection_circle_edit":
            MessageLookupByLibrary.simpleMessage("Çevreni düzenle"),
        "user__save_connection_circle_hint":
            MessageLookupByLibrary.simpleMessage(
                "örneğin Arkadaşlar, Aile, İş."),
        ...
        "user__save_follows_list_create":
            MessageLookupByLibrary.simpleMessage("Liste oluştur"),
        "user__save_follows_list_edit":
            MessageLookupByLibrary.simpleMessage("Listeyi düzenle"),
        "user__save_follows_list_emoji":
            MessageLookupByLibrary.simpleMessage("Emoji"),
        "user__save_follows_list_emoji_required_error":
            MessageLookupByLibrary.simpleMessage("Emoji gerekli"),
        "user__save_follows_list_hint_text":
            MessageLookupByLibrary.simpleMessage(
                "örneğin Seyahat, Fotoğrafçılık"),
        ...
        "user__timeline_filters_circles":
            MessageLookupByLibrary.simpleMessage("Çevreler"),
        "user__timeline_filters_clear_all":
            MessageLookupByLibrary.simpleMessage("Tümünü temizle"),
        "user__timeline_filters_lists":
            MessageLookupByLibrary.simpleMessage("Listeler"),
        "user__timeline_filters_no_match": m59,
        "user__timeline_filters_search_desc":
            MessageLookupByLibrary.simpleMessage(
                "Çevreleri ve listeleri ara..."),
        "user__timeline_filters_title":
            MessageLookupByLibrary.simpleMessage("Zaman Tüneli filtreleri"),
        "user__translate_see_translation":
            MessageLookupByLibrary.simpleMessage("Çeviriyi gör"),
        ...
        "user__uninvite":
            MessageLookupByLibrary.simpleMessage("Davet isteğini geri al"),
        "user__update_connection_circle_save":
            MessageLookupByLibrary.simpleMessage("Kaydet"),
        "user__update_connection_circle_updated":
            MessageLookupByLibrary.simpleMessage("Bağlantı güncellendi"),
        "user__update_connection_circles_title":
            MessageLookupByLibrary.simpleMessage(
                "Çevre bağlantılarını güncelle"),
        ...
        "user_search__list_retry":
            MessageLookupByLibrary.simpleMessage("Tekrar denemek için tıkla."),

...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(minLength, maxLength) =>
      "Beskrivelse skal være imellem ${minLength} og ${maxLength} tegn.";

  static m2(minLength, maxLength) =>
      "Navn skal være imellem ${minLength} og ${maxLength} tegn.";

  static m3(minLength, maxLength) =>
      "Adgangskoden skal være imellem ${minLength} og ${maxLength} tegn.";

  static m4(maxLength) =>
      "Et brugernavn kan ikke være længere end ${maxLength} tegn.";

  static m5(maxLength) =>
      "Kaldenavne kan ikke være længere end ${maxLength} tegn.";

  static m6(username) =>
      "Er du sikker på at du tilføje @${username} som fællesskabs administrator?";

  static m7(username) => "Er du sikker på, at du vil blokere @${username}?";

  static m8(maxLength) =>
      "Beskrivelsen kan ikke være længere end ${maxLength} tegn.";

  static m9(username) =>
      "Er du sikker på at du tilføje @${username} som fællesskabs moderator?";
  ...
  static m14(maxLength) =>
      "Regler kan ikke være længere end ${maxLength} tegn.";

  static m15(takenName) => "Fællesskabs navn \'${takenName}\' er i brug";

  static m16(maxLength) =>
      "Titlen kan ikke være længere end ${maxLength} tegn.";
  ...
  static m22(resourceCount, resourceName) =>
      "Se alle ${resourceCount} ${resourceName}";

  static m23(postCommentText) =>
      "[name] [username] kommenterede også: ${postCommentText}";

  static m24(postCommentText) =>
      "[name] [username] kommenterede på dit indlæg: ${postCommentText}";

  static m25(postCommentText) =>
      "[name] [username] svarede også: ${postCommentText}";
  ...
  static m29(communityName) =>
      "[name] [username] indbyder dig til at blive medlem i fælleskabet /c/${communityName}.";
  ...
  static m32(maxHashtags, maxCharacters) =>
      "Tilføj venligst højest ${maxHashtags} hashtags og hold dem under ${maxCharacters} tegn.";

  static m33(circlesSearchQuery) =>
      "Ingen cirkler indeholder \'${circlesSearchQuery}\'.";
  ...
  static m36(description) =>
      "Mislykkedes at forhåndsvise link med hjemmeside fejl: ${description}";

  static m37(maxLength) =>
      "Kredsnavn må ikke være længere end ${maxLength} tegn.";
  ...
  static m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Hej, jeg vil gerne invitere dig til Somus.\n\nFor Apple skal du først downloade TestFlight appen fra iTunes (${testFlightLink}) og så downloade Somus appen (${iosLink})\n\nFor Android skal du downloade den fra Play storen (${androidLink}).\n\nNæst kopier denne personaliserede invitations link i \'Sign up\' formen i Somus Appen: ${inviteLink}";
  ...
  static m53(maxLength) =>
      "Listenavn må ikke være længere end ${maxLength} tegn";

  static m54(maxLength) =>
      "Biografien kan ikke være længere end ${maxLength} tegn.";

  static m55(maxLength) => "Bopæl kan ikke være længere end ${maxLength} tegn.";

  static m56(age) => "På Somus siden ${age}";

  static m57(takenConnectionsCircleName) =>
      "Kredsnavn \'${takenConnectionsCircleName}\' er allerede taget";
  ...
  static m62(searchQuery) =>
      "Ingen fællesskaber fundet for \'${searchQuery}\'.";
  ...
  static _notInlinedMessages(_) => <String, Function>{
        "application_settings__comment_sort_newest_first":
            MessageLookupByLibrary.simpleMessage("Nyeste først"),
        "application_settings__comment_sort_oldest_first":
            MessageLookupByLibrary.simpleMessage("Ældste først"),
        "application_settings__link_previews":
            MessageLookupByLibrary.simpleMessage("Link forhåndsvisninger"),
        "application_settings__link_previews_autoplay_always":
            MessageLookupByLibrary.simpleMessage("Altid"),
        "application_settings__link_previews_autoplay_never":
            MessageLookupByLibrary.simpleMessage("Aldrig"),
        "application_settings__link_previews_autoplay_wifi_only":
            MessageLookupByLibrary.simpleMessage("Kun Wi-Fi"),
        "application_settings__link_previews_show":
            MessageLookupByLibrary.simpleMessage("Vis"),
        "application_settings__tap_to_change":
            MessageLookupByLibrary.simpleMessage("(Tryk for at ændre)"),
        "application_settings__videos":
            MessageLookupByLibrary.simpleMessage("Videoer"),
        "application_settings__videos_autoplay":
            MessageLookupByLibrary.simpleMessage("Automatisk afspilning"),
        ...
        "application_settings__videos_sound":
            MessageLookupByLibrary.simpleMessage("Lyd"),
        "application_settings__videos_sound_disabled":
            MessageLookupByLibrary.simpleMessage("Deaktiveret"),
        "application_settings__videos_sound_enabled":
            MessageLookupByLibrary.simpleMessage("Aktiveret"),
        "auth__change_password_current_pwd":
            MessageLookupByLibrary.simpleMessage("Nuværende adgangskode"),
        "auth__change_password_current_pwd_hint":
            MessageLookupByLibrary.simpleMessage(
                "Angiv den nuværende adgangskode"),
        ...
        "auth__change_password_new_pwd_error": MessageLookupByLibrary.simpleMessage(
            "Verificer venligst at adgangskoden er mellem 10 og 100 tegn lang"),
        "auth__change_password_new_pwd_hint":
            MessageLookupByLibrary.simpleMessage("Indtast din nye adgangskode"),
        "auth__change_password_save_success":
            MessageLookupByLibrary.simpleMessage(
                "Alt vel! Din adgangskode er opdateret"),
        "auth__change_password_save_text":
            MessageLookupByLibrary.simpleMessage("Gem"),
        "auth__change_password_title":
            MessageLookupByLibrary.simpleMessage("Ændre adgangskode"),
        "auth__create_acc__almost_there":
            MessageLookupByLibrary.simpleMessage("Næsten færdig..."),
        "auth__create_acc__are_you_legal_age":
            MessageLookupByLibrary.simpleMessage("Er du ældre end 16 år?"),
        ...
        "auth__create_acc__avatar_remove_photo":
            MessageLookupByLibrary.simpleMessage("Fjern billede"),
        "auth__create_acc__avatar_tap_to_change":
            MessageLookupByLibrary.simpleMessage("Tryk for at ændre"),
        "auth__create_acc__can_change_username":
            MessageLookupByLibrary.simpleMessage(
                "Hvis du ønsker, kan du altid ændre det via din profil side."),
        "auth__create_acc__congratulations":
            MessageLookupByLibrary.simpleMessage("Tillykke!"),
        ...
        "auth__create_acc__email_server_error":
            MessageLookupByLibrary.simpleMessage(
                "😭 Vi har problemer med vores servere, prøv venligst igen om et par minutter."),
        "auth__create_acc__email_taken_error":
            MessageLookupByLibrary.simpleMessage(
                "🤔 Der findes allerede en konto med denne email adresse."),
        "auth__create_acc__invalid_token":
            MessageLookupByLibrary.simpleMessage("Ugyldigt token"),
        "auth__create_acc__lets_get_started":
            MessageLookupByLibrary.simpleMessage("Lad os komme i gang"),
        "auth__create_acc__link_empty_error":
            MessageLookupByLibrary.simpleMessage(
                "Link feltet må ikke være tomt."),
        "auth__create_acc__link_invalid_error":
            MessageLookupByLibrary.simpleMessage(
                "Dette felt er ugyldigt (automatisk kopi)"),
        "auth__create_acc__name_characters_error":
            MessageLookupByLibrary.simpleMessage(
                "😅 Et brugernavn kan kun indeholde alfanumeriske tegn (indtil vidre)."),
        "auth__create_acc__name_empty_error":
            MessageLookupByLibrary.simpleMessage(
                "😱 Dit navn må ikke være tomt."),
        "auth__create_acc__name_length_error": MessageLookupByLibrary.simpleMessage(
            "😱 Dit navn kan ikke være længere end 50 tegn. (Hvis det er, beklager vi meget.)"),
        ...
        "auth__create_acc__username_taken_error":
            MessageLookupByLibrary.simpleMessage(
                "😩 Brugernavnet @%s er allerede benyttet."),
        "auth__create_acc__validating_token":
            MessageLookupByLibrary.simpleMessage("Validerer tokenet"),
        "auth__create_acc__welcome_to_beta":
            MessageLookupByLibrary.simpleMessage("Velkommen til beta!"),
        "auth__create_acc__what_avatar":
            MessageLookupByLibrary.simpleMessage("Tilføj et profilbillede"),
        "auth__create_acc__what_email":
            MessageLookupByLibrary.simpleMessage("Hvad er din email?"),
        "auth__create_acc__what_name":
            MessageLookupByLibrary.simpleMessage("Hvad er dit navn?"),
        "auth__create_acc__what_password":
            MessageLookupByLibrary.simpleMessage("Vælg en adgangskode"),
        "auth__create_acc__what_password_subtext":
            MessageLookupByLibrary.simpleMessage("(min 10 tegn.)"),
        "auth__create_acc__what_username":
            MessageLookupByLibrary.simpleMessage("Vælg et brugernavn"),
        "auth__create_acc__your_subscribed":
            MessageLookupByLibrary.simpleMessage(
                "Du er nr. {0} på ventelisten."),
        "auth__create_acc__your_username_is":
            MessageLookupByLibrary.simpleMessage("Dit brugernavn er "),
        "auth__create_acc_password_hint_text": m0,
        "auth__create_account":
            MessageLookupByLibrary.simpleMessage("Tilmeld dig"),
        ...
        "auth__email_empty_error": MessageLookupByLibrary.simpleMessage(
            "Email adresse kan ikke være tom."),
        ...
        "auth__login__connection_error": MessageLookupByLibrary.simpleMessage(
            "Vi kan ikke forbinde til vores servere. Er du forbundet med internettet?"),
        "auth__login__credentials_mismatch_error":
            MessageLookupByLibrary.simpleMessage(
                "De angivne oplysninger er ikke gyldige."),
        ...
        "auth__login__previous":
            MessageLookupByLibrary.simpleMessage("Forrige"),
        "auth__login__server_error": MessageLookupByLibrary.simpleMessage(
            "Æh øh... Vi oplever problemer med serverne. Prøv venligst igen om nogle minutter."),
        ...
        "auth__login__username_characters_error":
            MessageLookupByLibrary.simpleMessage(
                "Et brugernavn kan kun indeholde alfanumeriske tegn og underscore."),
        "auth__login__username_empty_error":
            MessageLookupByLibrary.simpleMessage(
                "Brugernavnet er obligatorisk."),
        ...
        "community__actions_disable_new_post_notifications_success":
            MessageLookupByLibrary.simpleMessage(
                "Meddelelser om nye indlæg slået fra"),
        "community__actions_disable_new_post_notifications_title":
            MessageLookupByLibrary.simpleMessage(
                "Slå meddelelser om nye indlæg fra"),
        "community__actions_enable_new_post_notifications_success":
            MessageLookupByLibrary.simpleMessage(
                "Meddelelser om nye indlæg slået til"),
        "community__actions_enable_new_post_notifications_title":
            MessageLookupByLibrary.simpleMessage(
                "Slå meddelelser om nye indlæg til"),
        "community__actions_invite_people_title":
            MessageLookupByLibrary.simpleMessage("Inviter til fællesskab"),
        "community__actions_manage_text":
            MessageLookupByLibrary.simpleMessage("Administrere"),
        "community__add_administrators_title":
            MessageLookupByLibrary.simpleMessage("Tilføj administrator."),
        "community__add_moderator_title":
            MessageLookupByLibrary.simpleMessage("Tilføj en moderator"),
        ...
        "community__administrator_plural":
            MessageLookupByLibrary.simpleMessage("administratorer"),
        "community__administrator_text":
            MessageLookupByLibrary.simpleMessage("administrator"),
        "community__administrator_you":
            MessageLookupByLibrary.simpleMessage("Dig"),
        "community__administrators_title":
            MessageLookupByLibrary.simpleMessage("Administratorer"),
        "community__ban_confirmation": m7,
        "community__ban_desc": MessageLookupByLibrary.simpleMessage(
            "Dette vil fjerne brugeren fra fællesskabet og forhindre den i at blive medlem igen."),
        "community__ban_user_title":
            MessageLookupByLibrary.simpleMessage("Bloker bruger"),
        "community__banned_user_text":
            MessageLookupByLibrary.simpleMessage("blokerede brugere"),
        ...
        "community__communities_no_category_found":
            MessageLookupByLibrary.simpleMessage(
                "Ingen kategorier fundet. Prøv igen om nogle minutter."),
        ...
        "community__community":
            MessageLookupByLibrary.simpleMessage("fællesskab"),
        "community__community_members":
            MessageLookupByLibrary.simpleMessage("Fællesskabs medlemmer"),
        "community__community_staff":
            MessageLookupByLibrary.simpleMessage("Fællesskabs administration"),
        "community__confirmation_title":
            MessageLookupByLibrary.simpleMessage("Bekræftelse"),
        "community__delete_confirmation": MessageLookupByLibrary.simpleMessage(
            "Er du sikker på at du vil slette fællesskabet?"),
        "community__delete_desc": MessageLookupByLibrary.simpleMessage(
            "Du vil ikke længere se dens opslag i din tidslinje og kan heller ikke lave opslag til den længere."),
        "community__description_range_error": m8,
        "community__details_favorite":
            MessageLookupByLibrary.simpleMessage("I favoritter"),
        "community__exclude_joined_communities":
            MessageLookupByLibrary.simpleMessage(
                "Ekskluder grupper du meldte dig ind i"),
        ...
        "community__manage_invite_desc": MessageLookupByLibrary.simpleMessage(
            "Inviter dine forbindelser og følgere til at slutte sig til fællesskabet."),
        "community__manage_invite_title":
            MessageLookupByLibrary.simpleMessage("Inviter personer"),
        "community__manage_leave_desc":
            MessageLookupByLibrary.simpleMessage("Forlad fællesskabet."),
        "community__manage_leave_title":
            MessageLookupByLibrary.simpleMessage("Forlad fællesskab"),
        "community__manage_mod_reports_desc":
            MessageLookupByLibrary.simpleMessage(
                "Gennemse fællesskabets moderations rapporter."),
        "community__manage_mod_reports_title":
            MessageLookupByLibrary.simpleMessage("Moderations rapporter"),
        "community__manage_mods_desc": MessageLookupByLibrary.simpleMessage(
            "Se, tilføje og fjerne moderatorer."),
        "community__manage_mods_title":
            MessageLookupByLibrary.simpleMessage("Moderatorer"),
        "community__manage_remove_favourite":
            MessageLookupByLibrary.simpleMessage(
                "Fjern fællesskabet fra dine favoritter"),
        "community__manage_title":
            MessageLookupByLibrary.simpleMessage("Administrere fællesskab"),
        ...
        "community__moderator_desc": MessageLookupByLibrary.simpleMessage(
            "Dette vil tillade medlemmet at redigere fællesskabs detaljerne, moderatorer og blokerede brugere."),
        ...
        "community__refreshing":
            MessageLookupByLibrary.simpleMessage("Opdaterer fællesskab"),
        "community__retry_loading_posts":
            MessageLookupByLibrary.simpleMessage("Tryk for at prøve igen"),
        "community__rules_empty_error":
            MessageLookupByLibrary.simpleMessage("Regler er obligatoriske."),
        ...
        "community__save_community_name_member_invites":
            MessageLookupByLibrary.simpleMessage("Medlems invitationer"),
        "community__save_community_name_member_invites_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "Medlemmer kan invitere folk til fællesskabet"),
        ...
        "community__title_empty_error":
            MessageLookupByLibrary.simpleMessage("Titel må ikke være tom."),
        "community__title_range_error": m16,
        "community__top_posts_excluded_communities":
            MessageLookupByLibrary.simpleMessage("Ekskluderede grupper"),
        "community__top_posts_excluded_communities_desc":
            MessageLookupByLibrary.simpleMessage(
                "Forvalt grupper der er udelukket fra oversigts-tidlinie"),
        "community__top_posts_settings":
            MessageLookupByLibrary.simpleMessage("Undersøg indstillinger"),
        "community__trending_in_all":
            MessageLookupByLibrary.simpleMessage("Populær i alle kategorier"),
        "community__trending_in_category": m17,
        "community__trending_none_found": MessageLookupByLibrary.simpleMessage(
            "Ingen populære fællesskaber fundet. Prøv igen om få minutter."),
        ...
        "community__unfavorite_action": MessageLookupByLibrary.simpleMessage(
            "Fjern fællesskab fra favoritter"),
        ...
        "contextual_account_search_box__no_results":
            MessageLookupByLibrary.simpleMessage("Ingen resultater fundet"),
        "contextual_account_search_box__suggestions":
            MessageLookupByLibrary.simpleMessage("Forslag"),
        ...
        "drawer__account_settings":
            MessageLookupByLibrary.simpleMessage("Konto Indstillinger"),
        "drawer__account_settings_blocked_users":
            MessageLookupByLibrary.simpleMessage("Blokerede brugere"),
        "drawer__account_settings_change_email":
            MessageLookupByLibrary.simpleMessage("Skift Email"),
        ...
        "drawer__account_settings_delete_account":
            MessageLookupByLibrary.simpleMessage("Slet konto"),
        "drawer__account_settings_language": m20,
        "drawer__account_settings_language_text":
            MessageLookupByLibrary.simpleMessage("Sprog"),
        ...
        "drawer__application_settings":
            MessageLookupByLibrary.simpleMessage("App-indstillinger"),
        "drawer__connections":
            MessageLookupByLibrary.simpleMessage("Mine forbindelser"),
        "drawer__customize": MessageLookupByLibrary.simpleMessage("Tilpas"),
        "drawer__developer_settings":
            MessageLookupByLibrary.simpleMessage("Udviklerindstillinger"),
        ...
        "drawer__main_title": MessageLookupByLibrary.simpleMessage("Mit Somus"),
        "drawer__menu_title": MessageLookupByLibrary.simpleMessage("Menu"),
        "drawer__my_circles":
            MessageLookupByLibrary.simpleMessage("Mine cirkler"),
        "drawer__my_followers":
            MessageLookupByLibrary.simpleMessage("Mine følgere"),
        "drawer__my_following":
            MessageLookupByLibrary.simpleMessage("Hvem jeg følger"),
        "drawer__my_invites":
            MessageLookupByLibrary.simpleMessage("Mine invitationer"),
        ...
        "drawer__my_mod_penalties": MessageLookupByLibrary.simpleMessage(
            "Mine moderations straffe points"),
        "drawer__my_pending_mod_tasks": MessageLookupByLibrary.simpleMessage(
            "Mine udestående moderations opgaver"),
        ...
        "drawer__useful_links_guidelines":
            MessageLookupByLibrary.simpleMessage("Somus retningslinjer"),
        "drawer__useful_links_guidelines_bug_tracker":
            MessageLookupByLibrary.simpleMessage("Indberetning af fejl"),
        "drawer__useful_links_guidelines_bug_tracker_desc":
            MessageLookupByLibrary.simpleMessage(
                "Indberet fejl eller stem på foreslåede rettelser"),
        "drawer__useful_links_guidelines_desc":
            MessageLookupByLibrary.simpleMessage(
                "De retningslinjer, som vi alle forventes at følge for et sundt og venskabeligt samvær."),
        "drawer__useful_links_guidelines_feature_requests":
            MessageLookupByLibrary.simpleMessage("Foreslå ny funktionalitet"),
        "drawer__useful_links_guidelines_feature_requests_desc":
            MessageLookupByLibrary.simpleMessage(
                "Foreslå ny funktionalitet eller stem på eksisterende forslag"),
        ...
        "drawer__useful_links_guidelines_github_desc":
            MessageLookupByLibrary.simpleMessage(
                "Se hvad vi i øjeblikket arbejder med"),
        "drawer__useful_links_guidelines_handbook":
            MessageLookupByLibrary.simpleMessage("Somus håndbog"),
        "drawer__useful_links_guidelines_handbook_desc":
            MessageLookupByLibrary.simpleMessage(
                "En bog med alt hvad der er værd at vide om at benytte platformen"),
        "drawer__useful_links_slack_channel":
            MessageLookupByLibrary.simpleMessage("Fællesskabets Slack Channel"),
        "drawer__useful_links_slack_channel_desc":
            MessageLookupByLibrary.simpleMessage(
                "Stedet hvor alt om Somus diskuteres"),
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Støt Somus"),
        "drawer__useful_links_support_desc":
            MessageLookupByLibrary.simpleMessage(
                "Find en vej at støtte os på vores tur!"),
        "drawer__useful_links_title":
            MessageLookupByLibrary.simpleMessage("Nyttige links"),
        "error__no_internet_connection":
            MessageLookupByLibrary.simpleMessage("Ingen internetforbindelse"),
        "error__unknown_error":
            MessageLookupByLibrary.simpleMessage("Ukendt fejl"),
        "image_picker__error_too_large": m21,
        "image_picker__from_camera":
            MessageLookupByLibrary.simpleMessage("Fra kamera"),
        "image_picker__from_gallery":
            MessageLookupByLibrary.simpleMessage("Fra galleri"),
        "media_service__crop_image":
            MessageLookupByLibrary.simpleMessage("Beskær billede"),
        "moderation__actions_chat_with_team":
            MessageLookupByLibrary.simpleMessage("Chat med teamet"),
        "moderation__actions_review":
            MessageLookupByLibrary.simpleMessage("Gennemgå"),
        "moderation__category_text":
            MessageLookupByLibrary.simpleMessage("Kategori"),
        "moderation__community_moderated_objects":
            MessageLookupByLibrary.simpleMessage(
                "Fællesskabs modererede objekter"),
        "moderation__community_review_approve":
            MessageLookupByLibrary.simpleMessage("Godkend"),
        "moderation__community_review_item_verified":
            MessageLookupByLibrary.simpleMessage(
                "Denne anmeldelse er gennemgået"),
        "moderation__community_review_object":
            MessageLookupByLibrary.simpleMessage("Objekt"),
        "moderation__community_review_reject":
            MessageLookupByLibrary.simpleMessage("afvis"),
        "moderation__community_review_title":
            MessageLookupByLibrary.simpleMessage("Gennemse moderet objekt"),
        "moderation__confirm_report_community_reported":
            MessageLookupByLibrary.simpleMessage("Fællesskabs anmeldelse"),
        "moderation__confirm_report_item_reported":
            MessageLookupByLibrary.simpleMessage("Objekt anmeldt"),
        "moderation__confirm_report_post_comment_reported":
            MessageLookupByLibrary.simpleMessage(
                "Opslags kommentar anmeldelse"),
        "moderation__confirm_report_post_reported":
            MessageLookupByLibrary.simpleMessage("Opslags anmeldelse"),
        "moderation__confirm_report_provide_details":
            MessageLookupByLibrary.simpleMessage(
                "Kan du tilføje ekstra detaljer som kan være relevante for anmeldelsen?"),
        "moderation__confirm_report_provide_happen_next":
            MessageLookupByLibrary.simpleMessage(
                "Her er hvad der vil ske efterfølgende:"),
        "moderation__confirm_report_provide_happen_next_desc":
            MessageLookupByLibrary.simpleMessage(
                "- Din anmeldelse vil blive indsendt anonymt. \n- Hvis du anmelder et opslag eller en kommentar, vil anmeldelsen blive sendt til Somus personalet og fællesskabs moderatorerne hvis relevant og opslaget vil blive skjult fra dit feed. \n- Hvis du anmelder en konto eller et fællesskab, vil det blive sendt til Somus personalet. \n- Vi vil gennemgå det og hvis det godkendes, vil indhold blive slettet og sanktioner givet til de involverede, gående fra en midlertidig udelukkelse til sletning a kontoen, afhængig af alvorligheden af overtrædelsen. \n- Hvis anmeldelsen vurderes at være lavet i et forsøg på at skade et andet medlem eller fællesskab på platformen, uden nogen overtrædelse af den angivne type, vil sanktioner blive givet til dig. \n"),
        "moderation__confirm_report_provide_optional_hint_text":
            MessageLookupByLibrary.simpleMessage("Skriv her..."),
        "moderation__confirm_report_provide_optional_info":
            MessageLookupByLibrary.simpleMessage("(Valgfrit)"),
        "moderation__confirm_report_submit":
            MessageLookupByLibrary.simpleMessage("Forstået, indsend."),
        "moderation__confirm_report_title":
            MessageLookupByLibrary.simpleMessage("Indsend anmeldelse"),
        "moderation__confirm_report_user_reported":
            MessageLookupByLibrary.simpleMessage("Bruger anmeldelse"),
        "moderation__description_text":
            MessageLookupByLibrary.simpleMessage("Beskrivelse"),
        "moderation__filters_apply":
            MessageLookupByLibrary.simpleMessage("Anvend filtre"),
        "moderation__filters_other":
            MessageLookupByLibrary.simpleMessage("Andre"),
        "moderation__filters_reset":
            MessageLookupByLibrary.simpleMessage("Nulstil"),
        ...
        "moderation__filters_verified":
            MessageLookupByLibrary.simpleMessage("Verificerede"),
        "moderation__global_review_object_text":
            MessageLookupByLibrary.simpleMessage("Objekt"),
        "moderation__global_review_title":
            MessageLookupByLibrary.simpleMessage("Gennemse moderet objekt"),
        "moderation__global_review_unverify_text":
            MessageLookupByLibrary.simpleMessage("Fjern verificering"),
        "moderation__global_review_verify_text":
            MessageLookupByLibrary.simpleMessage("Verificer"),
        "moderation__globally_moderated_objects":
            MessageLookupByLibrary.simpleMessage("Globalt modererede objekter"),
        "moderation__moderated_object_false_text":
            MessageLookupByLibrary.simpleMessage("Nej"),
        "moderation__moderated_object_reports_count":
            MessageLookupByLibrary.simpleMessage("Anmeldelses antal"),
        ...
        "moderation__moderated_object_verified":
            MessageLookupByLibrary.simpleMessage("Gennemset"),
        "moderation__moderated_object_verified_by_staff":
            MessageLookupByLibrary.simpleMessage(
                "Gennemset af Somus personale"),
        "moderation__my_moderation_penalties_resouce_singular":
            MessageLookupByLibrary.simpleMessage("moderations straffe"),
        "moderation__my_moderation_penalties_resource_plural":
            MessageLookupByLibrary.simpleMessage("moderations straffer"),
        "moderation__my_moderation_penalties_title":
            MessageLookupByLibrary.simpleMessage("Moderations straffer"),
        "moderation__my_moderation_tasks_title":
            MessageLookupByLibrary.simpleMessage(
                "Udestående moderationsopgaver"),
        "moderation__no_description_text":
            MessageLookupByLibrary.simpleMessage("Ingen beskrivelse"),
        ...
        "moderation__pending_moderation_tasks_singular":
            MessageLookupByLibrary.simpleMessage(
                "udestående moderationsopgave"),
        "moderation__report_account_text":
            MessageLookupByLibrary.simpleMessage("Anmeld konto"),
        "moderation__report_comment_text":
            MessageLookupByLibrary.simpleMessage("Anmeld kommentar"),
        "moderation__report_community_text":
            MessageLookupByLibrary.simpleMessage("Anmeld fællesskab"),
        "moderation__report_hashtag_text":
            MessageLookupByLibrary.simpleMessage("Rapporter hashtaget"),
        "moderation__report_post_text":
            MessageLookupByLibrary.simpleMessage("Anmeld opslag"),
        "moderation__reporter_text":
            MessageLookupByLibrary.simpleMessage("Rapporter"),
        "moderation__reports_preview_resource_reports":
            MessageLookupByLibrary.simpleMessage("anmelder"),
        ...
        "moderation__tap_to_retry": MessageLookupByLibrary.simpleMessage(
            "Tryk for at forsøge genindlæsning"),
        "moderation__update_category_save":
            MessageLookupByLibrary.simpleMessage("Gem"),
        "moderation__update_category_title":
            MessageLookupByLibrary.simpleMessage("Opdater Kategori"),
        "moderation__update_description_report_desc":
            MessageLookupByLibrary.simpleMessage("Anmeldelses beskrivelse"),
        "moderation__update_description_report_hint_text":
            MessageLookupByLibrary.simpleMessage(
                "f.eks Det anmeldte blev vurderet at..."),
        "moderation__update_description_save":
            MessageLookupByLibrary.simpleMessage("Gem"),
        "moderation__update_description_title":
            MessageLookupByLibrary.simpleMessage("Rediger beskrivelse"),
        "moderation__update_status_save":
            MessageLookupByLibrary.simpleMessage("Gem"),
        "moderation__update_status_title":
            MessageLookupByLibrary.simpleMessage("Opdater status"),
        "moderation__you_have_reported_account_text":
            MessageLookupByLibrary.simpleMessage("Du har anmeldt denne konto"),
        "moderation__you_have_reported_comment_text":
            MessageLookupByLibrary.simpleMessage(
                "Du har anmeldt denne kommentar"),
        "moderation__you_have_reported_community_text":
            MessageLookupByLibrary.simpleMessage(
                "Du har anmeldt dette fællesskab"),
        "moderation__you_have_reported_hashtag_text":
            MessageLookupByLibrary.simpleMessage(
                "Du har rapporteret dette hashtag"),
        "moderation__you_have_reported_post_text":
            MessageLookupByLibrary.simpleMessage("Du har anmeldt dette opslag"),
        "notifications__accepted_connection_request_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] godkendte din anmodning om at indgå forbindelse"),
        ...
        "notifications__comment_desc": MessageLookupByLibrary.simpleMessage(
            "Få besked når nogen kommenterer på et af dine indlæg eller på et du også kommenterede på"),
        "notifications__comment_reaction_desc":
            MessageLookupByLibrary.simpleMessage(
                "Få besked når nogen reagerer på en af dine kommentarer til indlægget"),
        "notifications__comment_reaction_title":
            MessageLookupByLibrary.simpleMessage("Send reaktion på kommentar"),
        "notifications__comment_reply_desc": MessageLookupByLibrary.simpleMessage(
            "Få besked når nogen svarer på en af dine kommentarer eller på en du også svarede på"),
        ...
        "notifications__comment_reply_title":
            MessageLookupByLibrary.simpleMessage("Send svar på kommentar"),
        "notifications__comment_title":
            MessageLookupByLibrary.simpleMessage("Tilføj kommentar"),
        "notifications__comment_user_mention_desc":
            MessageLookupByLibrary.simpleMessage(
                "Få besked når nogen nævner dig i en af sine kommentarer"),
        "notifications__comment_user_mention_title":
            MessageLookupByLibrary.simpleMessage(
                "Send nævnelse af kommentaren"),
        "notifications__community_invite_desc":
            MessageLookupByLibrary.simpleMessage(
                "Få besked når nogen inviterer dig i et fælleskab"),
        "notifications__community_invite_title":
            MessageLookupByLibrary.simpleMessage("Invitation til fælleskabet"),
        "notifications__community_new_post_desc":
            MessageLookupByLibrary.simpleMessage(
                "Få meddelelse når der er et nyt indlæg i et fællesskab du har slået indlægs-meddelelser til for"),
        "notifications__community_new_post_tile": m27,
        "notifications__community_new_post_title":
            MessageLookupByLibrary.simpleMessage("Fællesskabsindlæg"),
        "notifications__connection_desc": MessageLookupByLibrary.simpleMessage(
            "Få besked når nogen ønsker at forbinde sig med dig"),
        "notifications__connection_request_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] ønsker at forbinde sig med dig"),
        "notifications__connection_title":
            MessageLookupByLibrary.simpleMessage("Kontaktanmodning"),
        "notifications__follow_desc": MessageLookupByLibrary.simpleMessage(
            "Få besked når nogen begynder at følge dig"),
        "notifications__follow_title":
            MessageLookupByLibrary.simpleMessage("Følg"),
        "notifications__following_you_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] følger dig nu."),
        "notifications__general_desc":
            MessageLookupByLibrary.simpleMessage("Få besked når noget sker"),
        ...
        "notifications__mentioned_in_post_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] nævnte dig i et indlæg."),
        "notifications__mute_post_turn_off_post_comment_notifications":
            MessageLookupByLibrary.simpleMessage(
                "Slå beskeder for kommentarer på indlæg fra"),
        "notifications__mute_post_turn_off_post_notifications":
            MessageLookupByLibrary.simpleMessage("Slå beskeder for indlæg fra"),
        "notifications__mute_post_turn_on_post_comment_notifications":
            MessageLookupByLibrary.simpleMessage(
                "Slå beskeder for kommentarer på indlæg til"),
        "notifications__mute_post_turn_on_post_notifications":
            MessageLookupByLibrary.simpleMessage("Slå beskeder for indlæg til"),
        "notifications__post_reaction_desc":
            MessageLookupByLibrary.simpleMessage(
                "Få besked når nogen reagerer på et af dine indlæg"),
        "notifications__post_reaction_title":
            MessageLookupByLibrary.simpleMessage("Send reaktion"),
        "notifications__post_user_mention_desc":
            MessageLookupByLibrary.simpleMessage(
                "Få besked når nogen nævner dig i en af sine indlæg"),
        "notifications__post_user_mention_title":
            MessageLookupByLibrary.simpleMessage("Send nævnelse"),
        "notifications__reacted_to_post_comment_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] reagerede på din kommentar til indlægget."),
        "notifications__reacted_to_post_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] reagerede på dit indlæg."),
        "notifications__settings_title":
            MessageLookupByLibrary.simpleMessage("Indstillinger for beskeder"),
        "notifications__tab_general":
            MessageLookupByLibrary.simpleMessage("Overordnet"),
        "notifications__tab_requests":
            MessageLookupByLibrary.simpleMessage("Forespørgsler"),
        "notifications__user_community_invite_tile": m29,
        "notifications__user_new_post_desc": MessageLookupByLibrary.simpleMessage(
            "Få meddelelse når der er et nyt indlæg fra en bruger du har slået meddelelser til for"),
        "notifications__user_new_post_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] skrev noget."),
        "notifications__user_new_post_title":
            MessageLookupByLibrary.simpleMessage("Ny bruger indlæg"),
        "permissions_service__camera_permission_denied":
            MessageLookupByLibrary.simpleMessage(
                "Vi behøver adgang til dit kamera for at give dig lov til at tage billeder og optage videoer, tillad det venligst i dine indstillinger."),
        "permissions_service__storage_permission_denied":
            MessageLookupByLibrary.simpleMessage(
                "Vi behøver adgang til hukommelsen for at give dig lov til at tage media emner, tillad det venligst i dine indstillinger."),
        ...
        "post__actions_comment_deleted":
            MessageLookupByLibrary.simpleMessage("Kommentar slettet"),
        "post__actions_delete":
            MessageLookupByLibrary.simpleMessage("Slet opslag"),
        "post__actions_delete_comment":
            MessageLookupByLibrary.simpleMessage("Slet kommentar"),
        "post__actions_delete_comment_description":
            MessageLookupByLibrary.simpleMessage(
                "Kommentaren samt svarene og reaktionerne dertil vil slettes varig."),
        "post__actions_delete_description": MessageLookupByLibrary.simpleMessage(
            "Indlægget samt kommentarerne og reaktionerne dertil vil slettes varig."),
        "post__actions_deleted":
            MessageLookupByLibrary.simpleMessage("Opslag slettet"),
        "post__actions_edit_comment":
            MessageLookupByLibrary.simpleMessage("Rediger kommentar"),
        "post__actions_report_text":
            MessageLookupByLibrary.simpleMessage("Anmeld"),
        "post__actions_reported_text":
            MessageLookupByLibrary.simpleMessage("Anmeldt"),
        "post__actions_show_more_text":
            MessageLookupByLibrary.simpleMessage("Vis mere"),
        "post__close_create_post_label":
            MessageLookupByLibrary.simpleMessage("Luk \"opret nyt indlæg\""),
        ...
        "post__comment_reply_expanded_reply_comment":
            MessageLookupByLibrary.simpleMessage("Besvar kommentar"),
        "post__comment_reply_expanded_reply_hint_text":
            MessageLookupByLibrary.simpleMessage("Dit svar..."),
        "post__comment_required_error":
            MessageLookupByLibrary.simpleMessage("Kommentar er obligatorisk."),
        "post__commenter_expanded_edit_comment":
            MessageLookupByLibrary.simpleMessage("Rediger kommentar"),
        "post__commenter_expanded_join_conversation":
            MessageLookupByLibrary.simpleMessage("Deltag i samtalen..."),
        "post__commenter_expanded_save":
            MessageLookupByLibrary.simpleMessage("Gem"),
        "post__commenter_expanded_start_conversation":
            MessageLookupByLibrary.simpleMessage("Start en ny samtale..."),
        "post__commenter_post_text":
            MessageLookupByLibrary.simpleMessage("Opslag"),
        "post__commenter_write_something":
            MessageLookupByLibrary.simpleMessage("Skriv noget..."),
        "post__comments_closed_post":
            MessageLookupByLibrary.simpleMessage("Lukket opslag"),
        "post__comments_disabled":
            MessageLookupByLibrary.simpleMessage("Kommentarer deaktiveret"),
        "post__comments_disabled_message": MessageLookupByLibrary.simpleMessage(
            "Kommentarer deaktiveret for opslag"),
        "post__comments_enabled_message": MessageLookupByLibrary.simpleMessage(
            "Kommentarer aktiveret for opslag"),
        "post__comments_header_be_the_first_comments":
            MessageLookupByLibrary.simpleMessage(
                "Vær den første til at kommentere"),
        "post__comments_header_be_the_first_replies":
            MessageLookupByLibrary.simpleMessage("Vær den første til at svare"),
        "post__comments_header_newer":
            MessageLookupByLibrary.simpleMessage("Nyere"),
        "post__comments_header_newest_comments":
            MessageLookupByLibrary.simpleMessage("Nyeste kommentarer"),
        "post__comments_header_newest_replies":
            MessageLookupByLibrary.simpleMessage("Nyeste svar"),
        "post__comments_header_older":
            MessageLookupByLibrary.simpleMessage("Ældre"),
        "post__comments_header_oldest_comments":
            MessageLookupByLibrary.simpleMessage("Ældste kommentarer"),
        "post__comments_header_oldest_replies":
            MessageLookupByLibrary.simpleMessage("Ældste svar"),
        "post__comments_header_see_newest_comments":
            MessageLookupByLibrary.simpleMessage("Se nyeste kommentarer"),
        "post__comments_header_see_newest_replies":
            MessageLookupByLibrary.simpleMessage("Se nyeste svar"),
        "post__comments_header_see_oldest_comments":
            MessageLookupByLibrary.simpleMessage("Se ældste kommentarer"),
        "post__comments_header_see_oldest_replies":
            MessageLookupByLibrary.simpleMessage("Se ældste svar"),
        ...
        "post__comments_page_no_more_replies_to_load":
            MessageLookupByLibrary.simpleMessage("Ikke flere svar at hente"),
        "post__comments_page_no_more_to_load":
            MessageLookupByLibrary.simpleMessage(
                "Ikke flere kommentarer at hente"),
        "post__comments_page_replies_title":
            MessageLookupByLibrary.simpleMessage("Svar på opslag"),
        "post__comments_page_tap_to_retry":
            MessageLookupByLibrary.simpleMessage(
                "Tryk for at genindlæse kommentarer."),
        "post__comments_page_tap_to_retry_replies":
            MessageLookupByLibrary.simpleMessage(
                "Tryk for at genindlæse svar."),
        ...
        "post__create_new_community_post_label":
            MessageLookupByLibrary.simpleMessage("Opret nyt fælleskabsindlæg"),
        "post__create_new_post_label":
            MessageLookupByLibrary.simpleMessage("Opret nyt indlæg"),
        ...
        "post__disable_post_comments":
            MessageLookupByLibrary.simpleMessage("Deaktiver kommentarer"),
        ...
        "post__is_closed":
            MessageLookupByLibrary.simpleMessage("Lukket opslag"),
        "post__load_more":
            MessageLookupByLibrary.simpleMessage("Indlæs flere indlæg"),
        "post__my_circles":
            MessageLookupByLibrary.simpleMessage("Mine cirkler"),
        "post__my_circles_desc": MessageLookupByLibrary.simpleMessage(
            "Del opslaget til en eller flere af dine cirkler."),
        "post__no_circles_for": m33,
        "post__open_post": MessageLookupByLibrary.simpleMessage("Åben opslag"),
        "post__post_closed":
            MessageLookupByLibrary.simpleMessage("Opslag lukket "),
        "post__post_opened":
            MessageLookupByLibrary.simpleMessage("Opslag åbnet"),
        "post__post_reactions_title":
            MessageLookupByLibrary.simpleMessage("Opslags reaktioner"),
        "post__profile_counts_follower":
            MessageLookupByLibrary.simpleMessage(" Følger"),
        "post__profile_counts_followers":
            MessageLookupByLibrary.simpleMessage(" Følgere"),
        ...
        "post__reaction_list_tap_retry": MessageLookupByLibrary.simpleMessage(
            "Tryk for at genindlæse reaktioner."),
        ...
        "post__share_community_title":
            MessageLookupByLibrary.simpleMessage("Et fællesskab"),
        ...
        "post__sharing_post_to":
            MessageLookupByLibrary.simpleMessage("Deler opslag via"),
        "post__text_copied":
            MessageLookupByLibrary.simpleMessage("Tekst kopieret!"),
        ...
        "post__timeline_posts_all_loaded":
            MessageLookupByLibrary.simpleMessage("🎉 Alle opslag hentet"),
        "post__timeline_posts_default_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "Prøv at genindlæse tidslinjen."),
        "post__timeline_posts_default_drhoo_title":
            MessageLookupByLibrary.simpleMessage("Der er noget galt."),
        "post__timeline_posts_failed_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage("Prøv igen om nogle sekunder"),
        "post__timeline_posts_failed_drhoo_title":
            MessageLookupByLibrary.simpleMessage(
                "Kunne ikke indlæse din tidslinje."),
        "post__timeline_posts_no_more_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "Følg brugere eller deltag i et fællesskab for at komme i gang!"),
        "post__timeline_posts_refresh_posts":
            MessageLookupByLibrary.simpleMessage("Genindlæs opslag"),
        "post__timeline_posts_refreshing_drhoo_title":
            MessageLookupByLibrary.simpleMessage("Hav tålmodighed!"),
        "post__top_posts_title":
            MessageLookupByLibrary.simpleMessage("Udforsk"),
        "post__trending_posts_load_more":
            MessageLookupByLibrary.simpleMessage("Indlæs ældre indlæg"),
        "post__trending_posts_no_trending_posts":
            MessageLookupByLibrary.simpleMessage(
                "Der er ingen populære opslag. Prøv at opdatere om nogle sekunder."),
        ...
        "user__change_email_error":
            MessageLookupByLibrary.simpleMessage("Email allerede registreret"),
        "user__change_email_hint_text":
            MessageLookupByLibrary.simpleMessage("Indtast din emailadresse"),
        ...
        "user__change_email_success_info": MessageLookupByLibrary.simpleMessage(
            "Vi har sendt et bekræftelses link til din nye email adresse, klik det for at bekræfte din nye email"),
        "user__change_email_title":
            MessageLookupByLibrary.simpleMessage("Skift Email"),
        "user__circle_name_empty_error":
            MessageLookupByLibrary.simpleMessage("Kredsnavn må ikke være tom"),
        "user__circle_name_range_error": m37,
        "user__circle_peoples_count": m38,
        "user__clear_app_preferences_cleared_successfully":
            MessageLookupByLibrary.simpleMessage(
                "Nulstillede præferencer med succes"),
        "user__clear_app_preferences_desc": MessageLookupByLibrary.simpleMessage(
            "Nulstil app præferencer. I øjeblikket er dette den eneste foretrukne sortering af kommentarer."),
        "user__clear_app_preferences_error":
            MessageLookupByLibrary.simpleMessage(
                "Kunne ikke nulstille præferencer"),
        "user__clear_app_preferences_title":
            MessageLookupByLibrary.simpleMessage("Nulstil præferencer"),
        "user__clear_application_cache_desc":
            MessageLookupByLibrary.simpleMessage(
                "Tøm cachen for indlæg, konti, billeder & mere."),
        "user__clear_application_cache_failure":
            MessageLookupByLibrary.simpleMessage("Kunne ikke tømme cache"),
        "user__clear_application_cache_success":
            MessageLookupByLibrary.simpleMessage("Cache succesfuldt tømt"),
        "user__clear_application_cache_text":
            MessageLookupByLibrary.simpleMessage("Tøm cache"),
        "user__confirm_block_user_blocked":
            MessageLookupByLibrary.simpleMessage("Bruger blokeret."),
        "user__confirm_block_user_info": MessageLookupByLibrary.simpleMessage(
            "I vil hverken se hinandens indslæg eller være i stand til at interagere på nogen måde."),
        ...
        "user__confirm_connection_add_connection":
            MessageLookupByLibrary.simpleMessage("Føj kontakt til kreds"),
        "user__confirm_connection_confirm_text":
            MessageLookupByLibrary.simpleMessage("Bekræft"),
        ...
        "user__confirm_guidelines_reject_chat_with_team":
            MessageLookupByLibrary.simpleMessage("Snak med teamet."),
        ...
        "user__confirm_guidelines_reject_info":
            MessageLookupByLibrary.simpleMessage(
                "Du kan ikke bruge Somus før du accepterer retningslinjerne."),
        "user__confirm_guidelines_reject_join_slack":
            MessageLookupByLibrary.simpleMessage("Deltag i Slack kanalen."),
        "user__confirm_guidelines_reject_title":
            MessageLookupByLibrary.simpleMessage("Retningslinjernes afvisning"),
        "user__connect_to_user_add_connection":
            MessageLookupByLibrary.simpleMessage("Føj kontakt til kreds"),
        "user__connect_to_user_connect_with_username": m41,
        "user__connect_to_user_done":
            MessageLookupByLibrary.simpleMessage("Udført"),
        "user__connect_to_user_request_sent":
            MessageLookupByLibrary.simpleMessage("Kontaktanmodning sendt"),
        "user__connection_circle_edit":
            MessageLookupByLibrary.simpleMessage("Redigér"),
        "user__connection_pending":
            MessageLookupByLibrary.simpleMessage("Verserende"),
        "user__connections_circle_delete":
            MessageLookupByLibrary.simpleMessage("Slet"),
        "user__connections_header_circle_desc":
            MessageLookupByLibrary.simpleMessage(
                "Kredsen som alle dine forbindelser tilføjes."),
        "user__connections_header_users":
            MessageLookupByLibrary.simpleMessage("Brugere"),
        "user__delete_account_confirmation_desc":
            MessageLookupByLibrary.simpleMessage(
                "Er du sikker på, at du vil slette dit konto?"),
        "user__delete_account_confirmation_desc_info":
            MessageLookupByLibrary.simpleMessage(
                "Det er en endegyldig aktion og kan ikke kaldes tilbage."),
        "user__delete_account_confirmation_goodbye":
            MessageLookupByLibrary.simpleMessage("Farvel"),
        ...
        "user__delete_account_current_pwd_hint":
            MessageLookupByLibrary.simpleMessage(
                "Indtast din aktuel adgangskode"),
        ...
        "user__email_verification_error": MessageLookupByLibrary.simpleMessage(
            "Ups! Dit token var ikke validt, eller er udløbet. Prøv igen"),
        "user__email_verification_successful":
            MessageLookupByLibrary.simpleMessage(
                "Fantastisk! Din email er nu bekræftet"),
        "user__emoji_field_none_selected":
            MessageLookupByLibrary.simpleMessage("Ingen emoji valgt"),
        "user__emoji_search_none_found": m45,
        "user__enable_new_post_notifications":
            MessageLookupByLibrary.simpleMessage(
                "Slå meddelelser om nye indlæg til"),
        "user__follow_button_follow_back_text":
            MessageLookupByLibrary.simpleMessage("Følg tilbage"),
        "user__follow_button_follow_text":
            MessageLookupByLibrary.simpleMessage("Følg"),
        "user__follow_button_following_text":
            MessageLookupByLibrary.simpleMessage("Følger"),
        "user__follow_button_unfollow_text":
            MessageLookupByLibrary.simpleMessage("Følg ikke længere"),
        "user__follow_lists_no_list_found":
            MessageLookupByLibrary.simpleMessage("Ingen liste fundet."),
        "user__follow_lists_no_list_found_for": m46,
        "user__follow_lists_search_for":
            MessageLookupByLibrary.simpleMessage("Søg efter en liste..."),
        "user__follow_lists_title":
            MessageLookupByLibrary.simpleMessage("Mine lister"),
        ...
        "user__following_resource_name":
            MessageLookupByLibrary.simpleMessage("brugere der følger"),
        ...
        "user__guidelines_desc": MessageLookupByLibrary.simpleMessage(
            "Tag et øjeblik til at læse og acceptere vores retningslinjer."),
        ...
        "user__invites_accepted_group_item_name":
            MessageLookupByLibrary.simpleMessage("acceptered invitation"),
        "user__invites_accepted_group_name":
            MessageLookupByLibrary.simpleMessage("accepterede invitationer"),
        "user__invites_accepted_title":
            MessageLookupByLibrary.simpleMessage("Accepteret"),
        "user__invites_create_create":
            MessageLookupByLibrary.simpleMessage("Kreér"),
        "user__invites_create_create_title":
            MessageLookupByLibrary.simpleMessage("Kreér indbydelse"),
        "user__invites_create_edit_title":
            MessageLookupByLibrary.simpleMessage("Redigér indbydelse"),
        "user__invites_create_name_hint":
            MessageLookupByLibrary.simpleMessage("fx. Jane Doe"),
        ...
        "user__invites_email_hint":
            MessageLookupByLibrary.simpleMessage("f.eks. janedoe@email.com"),
        "user__invites_email_invite_text":
            MessageLookupByLibrary.simpleMessage("Email invitation"),
        "user__invites_email_send_text":
            MessageLookupByLibrary.simpleMessage("Send"),
        "user__invites_email_sent_text":
            MessageLookupByLibrary.simpleMessage("Invitationsemail sendt"),
        "user__invites_email_text":
            MessageLookupByLibrary.simpleMessage("Email"),
        "user__invites_invite_a_friend":
            MessageLookupByLibrary.simpleMessage("Inviter en ven"),
        "user__invites_invite_text":
            MessageLookupByLibrary.simpleMessage("Invitation"),
        "user__invites_joined_with": m51,
        "user__invites_none_left": MessageLookupByLibrary.simpleMessage(
            "Du har ingen invitationer tilbage."),
        "user__invites_none_used": MessageLookupByLibrary.simpleMessage(
            "Du har tilsyneladende ikke brugt nogen invitation endnu."),
        "user__invites_pending":
            MessageLookupByLibrary.simpleMessage("verserende"),
        "user__invites_pending_email": m52,
        "user__invites_pending_group_item_name":
            MessageLookupByLibrary.simpleMessage("verserende invitation"),
        "user__invites_pending_group_name":
            MessageLookupByLibrary.simpleMessage("verserende invitationer"),
        "user__invites_refresh":
            MessageLookupByLibrary.simpleMessage("Opdater"),
        "user__invites_share_email":
            MessageLookupByLibrary.simpleMessage("Del invitation per email"),
        "user__invites_share_email_desc": MessageLookupByLibrary.simpleMessage(
            "Vi skal sende en invitationsemail med instruktioner på dine vegne"),
        "user__invites_share_yourself":
            MessageLookupByLibrary.simpleMessage("Del selv invitation"),
        "user__invites_share_yourself_desc":
            MessageLookupByLibrary.simpleMessage(
                "Vælg fra messaging apps etc."),
        "user__invites_title":
            MessageLookupByLibrary.simpleMessage("Mine invitationer"),
        "user__language_settings_save":
            MessageLookupByLibrary.simpleMessage("Gem"),
        "user__language_settings_saved_success":
            MessageLookupByLibrary.simpleMessage("Sprogændring succesfuld"),
        "user__language_settings_title":
            MessageLookupByLibrary.simpleMessage("Sprogindstillinger"),
        "user__list_name_empty_error":
            MessageLookupByLibrary.simpleMessage("Listenavn må ikke være tom"),
        ...
        "user__profile_action_cancel_connection":
            MessageLookupByLibrary.simpleMessage(
                "Kald forspørgsel om forbindelse tilbage"),
        "user__profile_action_deny_connection":
            MessageLookupByLibrary.simpleMessage(
                "Afvis forespørgsel om forbindelse"),
        ...
        "user__profile_action_user_unblocked":
            MessageLookupByLibrary.simpleMessage("Blokering af bruger ophævet"),
        "user__profile_bio_length_error": m54,
        "user__profile_in_circles":
            MessageLookupByLibrary.simpleMessage("I kredse"),
        ...
        "user__remove_account_from_list":
            MessageLookupByLibrary.simpleMessage("Slet konto fra listen"),
        ...
        "user__save_connection_circle_create":
            MessageLookupByLibrary.simpleMessage("Kreér kreds"),
        "user__save_connection_circle_edit":
            MessageLookupByLibrary.simpleMessage("Redigér kreds"),
        "user__save_connection_circle_hint":
            MessageLookupByLibrary.simpleMessage(
                "fx venner, familie, arbejde."),
        ...
        "user__save_follows_list_create":
            MessageLookupByLibrary.simpleMessage("Opret liste"),
        "user__save_follows_list_edit":
            MessageLookupByLibrary.simpleMessage("Redigér liste"),
        "user__save_follows_list_emoji":
            MessageLookupByLibrary.simpleMessage("Emoji"),
        "user__save_follows_list_emoji_required_error":
            MessageLookupByLibrary.simpleMessage("Emoji er krævet"),
        "user__save_follows_list_hint_text":
            MessageLookupByLibrary.simpleMessage("f.eks rejse, fotografi"),
        ...
        "user__timeline_filters_circles":
            MessageLookupByLibrary.simpleMessage("Kredse"),
        "user__timeline_filters_clear_all":
            MessageLookupByLibrary.simpleMessage("Slet alt"),
        "user__timeline_filters_lists":
            MessageLookupByLibrary.simpleMessage("Lister"),
        "user__timeline_filters_no_match": m59,
        "user__timeline_filters_search_desc":
            MessageLookupByLibrary.simpleMessage(
                "Søger efter kredse og lister..."),
        "user__timeline_filters_title":
            MessageLookupByLibrary.simpleMessage("Tidslinjefiltre"),
        "user__translate_see_translation":
            MessageLookupByLibrary.simpleMessage("Se oversættelse"),
        "user__translate_show_original":
            MessageLookupByLibrary.simpleMessage("Vis originalet"),
        "user__unblock_user":
            MessageLookupByLibrary.simpleMessage("Fjern blokering af bruger"),
        "user__uninvite":
            MessageLookupByLibrary.simpleMessage("Kald indbydelse tilbage"),
        "user__update_connection_circle_save":
            MessageLookupByLibrary.simpleMessage("Gem"),
        "user__update_connection_circle_updated":
            MessageLookupByLibrary.simpleMessage("Kontakt opdateret"),
        "user__update_connection_circles_title":
            MessageLookupByLibrary.simpleMessage(
                "Aktualisér kontakternes kredse"),

...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(minLength, maxLength) =>
      "La descrizione deve essere compresa tra ${minLength} e ${maxLength} caratteri.";

  static m2(minLength, maxLength) =>
      "Il nome deve essere compreso tra ${minLength} e ${maxLength} caratteri.";

  static m3(minLength, maxLength) =>
      "La password deve essere compresa tra ${minLength} e ${maxLength} caratteri.";

  static m4(maxLength) =>
      "Un commento non può essere più lungo di ${maxLength} caratteri.";

  static m5(maxLength) =>
      "Gli aggettivi non possono essere più lunghi di ${maxLength} caratteri.";

  static m6(username) =>
      "Sei sicuro di voler aggiungere @${username} come amministratore della comunità?";

  static m7(username) => "Sei sicuro di voler bloccare @${username}?";

  static m8(maxLength) =>
      "La descrizione non può essere più lunga di ${maxLength} caratteri.";

  static m9(username) =>
      "Sei sicuro di voler aggiungere @${username} come moderatore della comunità?";
  ...
  static m14(maxLength) =>
      "Le regole non possono essere più lunghe di ${maxLength} caratteri.";

  static m15(takenName) =>
      "Il nome \'${takenName}\' per la comunità è già utilizzato";

  static m16(maxLength) =>
      "Il titolo non può essere più lungo di ${maxLength} caratteri.";
  ...
  static m22(resourceCount, resourceName) =>
      "Vedi tutti ${resourceCount} ${resourceName}";

  static m23(postCommentText) =>
      "anche [name] [username] ha commentato: ${postCommentText}";

  static m24(postCommentText) =>
      "[name] [username] ha commentato il tuo post: ${postCommentText}";

  static m25(postCommentText) =>
      "anche [name] [username] ha risposto: ${postCommentText}";
  ...
  static m29(communityName) =>
      "[name] [username] ti ha invitato a unirti alla comunità /c/${communityName}.";
  ...
  static m32(maxHashtags, maxCharacters) =>
      "Si prega di aggiungere un massimo di ${maxHashtags} hashtag e mantenerli sotto i ${maxCharacters} caratteri.";

  static m33(circlesSearchQuery) =>
      "Nessuna cerchia trovata corrisponde a \'${circlesSearchQuery}\'.";
  ...
  static m36(description) =>
      "Impossibile creare l’anteprima del link, il sito web riporta errore: ${description}";

  static m37(maxLength) =>
      "Il nome della cerchia non può essere più lungo di ${maxLength} caratteri.";
  ...
  static m45(searchQuery) =>
      "Nessun emoji trovato corrispondente a \'${searchQuery}\'.";
  ...
  static m50(iosLink, testFlightLink, androidLink, inviteLink) =>
      "Ehi, vorrei invitarti su Somus.\n\nPer Apple, prima scarica l\'app TestFlight su iTunes (${testFlightLink}) e poi scarica l\'app Somus (${iosLink})\n\nPer Android, scaricala dal Play store (${androidLink}).\n\nIn seguito, incolla questo link di invito personalizzato nel modulo \'Iscriviti\' nell\'App Somus: ${inviteLink}";
  ...
  static m53(maxLength) =>
      "Il nome della lista non può essere più lungo di ${maxLength} caratteri.";

  static m54(maxLength) =>
      "La biografia non può essere più lunga di ${maxLength} caratteri.";

  static m55(maxLength) =>
      "Il luogo non può essere più lungo di ${maxLength} caratteri.";

  static m56(age) => "Su Somus dal ${age}";

  static m57(takenConnectionsCircleName) =>
      "Nome cerchia \'${takenConnectionsCircleName}\' già utilizzato";

  static m58(listName) =>
      "Il nome per la lista \'${listName}\' è già utilizzato";

  static m59(searchQuery) => "Nessun risultato per \'${searchQuery}\'.";

  static m60(resourcePluralName) =>
  ...
  static _notInlinedMessages(_) => <String, Function>{
        ...
        "application_settings__link_previews":
            MessageLookupByLibrary.simpleMessage("Anteprime link"),
        ...
        "application_settings__link_previews_autoplay_wifi_only":
            MessageLookupByLibrary.simpleMessage("Solo WiFi"),
        "application_settings__link_previews_show":
            MessageLookupByLibrary.simpleMessage("Mostra"),
        "application_settings__tap_to_change":
            MessageLookupByLibrary.simpleMessage("(Tocca per cambiare)"),
        "application_settings__videos":
            MessageLookupByLibrary.simpleMessage("Video"),
        "application_settings__videos_autoplay":
            MessageLookupByLibrary.simpleMessage("Riproduzione automatica"),
        ...
        "application_settings__videos_autoplay_wifi_only":
            MessageLookupByLibrary.simpleMessage("Solo Wi-Fi"),
        "application_settings__videos_sound":
            MessageLookupByLibrary.simpleMessage("Suono"),
        "application_settings__videos_sound_disabled":
            MessageLookupByLibrary.simpleMessage("Disabilitato"),
        "application_settings__videos_sound_enabled":
            MessageLookupByLibrary.simpleMessage("Abilitato"),
        ...
        "auth__change_password_new_pwd_error": MessageLookupByLibrary.simpleMessage(
            "Per favore assicurati che la password sia compresa tra 10 e 100 caratteri"),
        "auth__change_password_new_pwd_hint":
            MessageLookupByLibrary.simpleMessage(
                "Inserisci la tua nuova password"),
        "auth__change_password_save_success":
            MessageLookupByLibrary.simpleMessage(
                "Tutto a posto! La tua password è stata aggiornata"),
        ...
        "auth__create_acc__almost_there":
            MessageLookupByLibrary.simpleMessage("Ci siamo quasi..."),
        ...
        "auth__create_acc__avatar_choose_gallery":
            MessageLookupByLibrary.simpleMessage("Usa una foto esistente"),
        ...
        "auth__create_acc__can_change_username":
            MessageLookupByLibrary.simpleMessage(
                "Se lo desideri, puoi cambiarlo in qualsiasi momento dalla pagina del profilo."),
        ...
        "auth__create_acc__done_subtext": MessageLookupByLibrary.simpleMessage(
            "Puoi cambiarlo nelle impostazioni del tuo account."),
        "auth__create_acc__done_title":
            MessageLookupByLibrary.simpleMessage("Urrà!"),
        ...
        "auth__create_acc__email_placeholder":
            MessageLookupByLibrary.simpleMessage("leonardo_davinci@mail.com"),
        "auth__create_acc__email_server_error":
            MessageLookupByLibrary.simpleMessage(
                "😭 Stiamo riscontrando problemi con i nostri server, per favore riprova tra un paio di minuti."),
        "auth__create_acc__email_taken_error":
            MessageLookupByLibrary.simpleMessage(
                "🤔 Un account esiste già per questa email."),
        ...
        "auth__create_acc__link_empty_error":
            MessageLookupByLibrary.simpleMessage(
                "Il link non può essere vuoto."),
        "auth__create_acc__link_invalid_error":
            MessageLookupByLibrary.simpleMessage("Questo link non è valido."),
        "auth__create_acc__name_characters_error":
            MessageLookupByLibrary.simpleMessage(
                "😅 Un nome può contenere solo caratteri alfanumerici (per ora)."),
        ...
        "auth__create_acc__name_length_error": MessageLookupByLibrary.simpleMessage(
            "😱 Il tuo nome non può essere più lungo di 50 caratteri. (Se lo è, ci dispiace molto.)"),
        ...
        "auth__create_acc__one_last_thing":
            MessageLookupByLibrary.simpleMessage("Un\'ultima cosa..."),
        "auth__create_acc__password_empty_error":
            MessageLookupByLibrary.simpleMessage(
                "😱 La tua password non può essere vuota"),
        "auth__create_acc__password_length_error":
            MessageLookupByLibrary.simpleMessage(
                "😅 La password deve essere compresa tra 8 e 64 caratteri."),
        "auth__create_acc__paste_link": MessageLookupByLibrary.simpleMessage(
            "Incolla il link di registrazione qui sotto"),
        "auth__create_acc__paste_link_help_text":
            MessageLookupByLibrary.simpleMessage(
                "Usa il link dal pulsante Join Somus nella tua email di invito."),
        "auth__create_acc__paste_password_reset_link":
            MessageLookupByLibrary.simpleMessage(
                "Incolla il link di reset della password qui sotto"),
        "auth__create_acc__previous":
            MessageLookupByLibrary.simpleMessage("Indietro"),
        "auth__create_acc__register":
            MessageLookupByLibrary.simpleMessage("Iscriviti"),
        "auth__create_acc__request_invite":
            MessageLookupByLibrary.simpleMessage(
                "Nessun invito? Richiedine uno qui."),
        "auth__create_acc__submit_error_desc_server":
            MessageLookupByLibrary.simpleMessage(
                "😭 Stiamo riscontrando problemi con i nostri server, per favore riprova tra un paio di minuti."),
        "auth__create_acc__submit_error_desc_validation":
            MessageLookupByLibrary.simpleMessage(
                "😅 Sembra che alcune informazioni non siano corrette, per favore controlla e prova di nuovo."),
        ...
        "auth__create_acc__submit_loading_title":
            MessageLookupByLibrary.simpleMessage("Ancora un attimo!"),
        "auth__create_acc__subscribe":
            MessageLookupByLibrary.simpleMessage("Richiedi"),
        "auth__create_acc__subscribe_to_waitlist_text":
            MessageLookupByLibrary.simpleMessage("Richiedi un invito!"),
        "auth__create_acc__suggested_communities":
            MessageLookupByLibrary.simpleMessage(
                "🥳 Comincia unendoti a queste comunità."),
        "auth__create_acc__username_characters_error":
            MessageLookupByLibrary.simpleMessage(
                "😅 Un nome utente può contenere solo caratteri alfanumerici e trattini bassi."),
        "auth__create_acc__username_empty_error":
            MessageLookupByLibrary.simpleMessage(
                "😱 Il nome utente non può essere vuoto."),
        "auth__create_acc__username_length_error":
            MessageLookupByLibrary.simpleMessage(
                "😅 Un nome utente non può essere più lungo di 30 caratteri."),
        "auth__create_acc__username_placeholder":
            MessageLookupByLibrary.simpleMessage("dantealighieri"),
        "auth__create_acc__username_server_error":
            MessageLookupByLibrary.simpleMessage(
                "😭 Stiamo riscontrando problemi con i nostri server, per favore riprova tra un paio di minuti."),
        "auth__create_acc__username_taken_error":
            MessageLookupByLibrary.simpleMessage(
                "😩 Il nome utente @%s è già utilizzato."),
        "auth__create_acc__validating_token":
            MessageLookupByLibrary.simpleMessage(
                "Sto convalidando il token..."),
        "auth__create_acc__welcome_to_beta":
            MessageLookupByLibrary.simpleMessage("Benvenuto nella Beta!"),
        "auth__create_acc__what_avatar":
            MessageLookupByLibrary.simpleMessage("Scegli una foto profilo"),
        "auth__create_acc__what_email":
            MessageLookupByLibrary.simpleMessage("Qual è la tua email?"),
        "auth__create_acc__what_name":
            MessageLookupByLibrary.simpleMessage("Come ti chiami?"),
        "auth__create_acc__what_password":
            MessageLookupByLibrary.simpleMessage("Scegli una password"),
        "auth__create_acc__what_password_subtext":
            MessageLookupByLibrary.simpleMessage("(minimo 10 caratteri.)"),
        "auth__create_acc__what_username":
            MessageLookupByLibrary.simpleMessage("Scegli un nome utente"),
        "auth__create_acc__your_subscribed":
            MessageLookupByLibrary.simpleMessage(
                "Sei in posizione {0} della lista d\'attesa."),
        "auth__create_acc__your_username_is":
            MessageLookupByLibrary.simpleMessage("Il tuo nome utente è "),
        ...
        "auth__email_invalid_error": MessageLookupByLibrary.simpleMessage(
            "Per favore inserisci un indirizzo email valido."),
        "auth__headline":
            MessageLookupByLibrary.simpleMessage("Un social migliore. "),
        ...
        "auth__login__connection_error": MessageLookupByLibrary.simpleMessage(
            "Non possiamo raggiungere i nostri server. Sei connesso a internet?"),
        "auth__login__credentials_mismatch_error":
            MessageLookupByLibrary.simpleMessage(
                "Le credenziali fornite non corrispondono."),
        ...
        "auth__login__password_empty_error":
            MessageLookupByLibrary.simpleMessage("La password è necessaria."),
        ...
        "auth__login__server_error": MessageLookupByLibrary.simpleMessage(
            "Oh oh... Stiamo avendo dei problemi sui server. Per favore riprova tra qualche minuto."),
        ...
        "auth__login__username_characters_error":
            MessageLookupByLibrary.simpleMessage(
                "Il nome utente può contenere solo caratteri alfanumerici e trattini bassi."),
        "auth__login__username_empty_error":
            MessageLookupByLibrary.simpleMessage("Il nome utente è richiesto."),
        "auth__login__username_label":
            MessageLookupByLibrary.simpleMessage("Nome utente"),
        "auth__login__username_length_error":
            MessageLookupByLibrary.simpleMessage(
                "Il nome utente non può essere più lungo di 30 caratteri."),
        ...
        "community__administrator_plural":
            MessageLookupByLibrary.simpleMessage("amministratori"),
        "community__administrator_text":
            MessageLookupByLibrary.simpleMessage("amministratore"),
        ...
        "community__ban_desc": MessageLookupByLibrary.simpleMessage(
            "Questo rimuoverà l\'utente dalla comunità e gli impedirà di unirsi nuovamente."),
        "community__ban_user_title":
            MessageLookupByLibrary.simpleMessage("Blocca utente"),
        "community__banned_user_text":
            MessageLookupByLibrary.simpleMessage("utente bloccato"),
        "community__banned_users_text":
            MessageLookupByLibrary.simpleMessage("utenti bloccati"),
        "community__banned_users_title":
            MessageLookupByLibrary.simpleMessage("Utenti Bloccati"),
        "community__button_rules":
            MessageLookupByLibrary.simpleMessage("Regole"),
        "community__button_staff":
            MessageLookupByLibrary.simpleMessage("Addetti"),
        ...
        "community__communities_all_text":
            MessageLookupByLibrary.simpleMessage("Tutte"),
        "community__communities_no_category_found":
            MessageLookupByLibrary.simpleMessage(
                "Nessuna categoria trovata. Riprova tra qualche minuto."),
        ...
        "community__community_staff":
            MessageLookupByLibrary.simpleMessage("Addetti della comunità"),
        ...
        "community__delete_confirmation": MessageLookupByLibrary.simpleMessage(
            "Sei sicuro di voler eliminare la comunità?"),
        "community__delete_desc": MessageLookupByLibrary.simpleMessage(
            "Non ne vedrai i post sulla tua timeline né potrai più postare."),
        "community__description_range_error": m8,
        "community__details_favorite":
            MessageLookupByLibrary.simpleMessage("Nei preferiti"),
        "community__exclude_joined_communities":
            MessageLookupByLibrary.simpleMessage(
                "Escludi comunità sottoscritte"),
        ...
        "community__invite_to_community_resource_plural":
            MessageLookupByLibrary.simpleMessage("connessioni e follower"),
        "community__invite_to_community_resource_singular":
            MessageLookupByLibrary.simpleMessage("connessione o follower"),
        "community__invite_to_community_title":
            MessageLookupByLibrary.simpleMessage("Invita nella comunità"),
        "community__invited_by_member": MessageLookupByLibrary.simpleMessage(
            "Devi essere invitato da un membro."),
        "community__invited_by_moderator": MessageLookupByLibrary.simpleMessage(
            "Devi essere invitato da un moderatore."),
        ...
        "community__manage_invite_desc": MessageLookupByLibrary.simpleMessage(
            "Invita le tue connessioni e i tuoi follower a unirsi alla comunità."),
        "community__manage_invite_title":
            MessageLookupByLibrary.simpleMessage("Invita persone"),
        "community__manage_leave_desc":
            MessageLookupByLibrary.simpleMessage("Lascia la comunità."),
        "community__manage_leave_title":
            MessageLookupByLibrary.simpleMessage("Lascia comunità"),
        "community__manage_mod_reports_desc":
            MessageLookupByLibrary.simpleMessage(
                "Controlla le segnalazioni di moderazione della comunità."),
        "community__manage_mod_reports_title":
            MessageLookupByLibrary.simpleMessage("Segnalazioni moderazione"),
        "community__manage_mods_desc": MessageLookupByLibrary.simpleMessage(
            "Vedi, aggiungi e rimuovi moderatori."),
        "community__manage_mods_title":
            MessageLookupByLibrary.simpleMessage("Moderatori"),
        "community__manage_remove_favourite":
            MessageLookupByLibrary.simpleMessage(
                "Rimuovi la comunità dai tuoi preferiti"),
        "community__manage_title":
            MessageLookupByLibrary.simpleMessage("Gestisci comunità"),
        ...
        "community__moderator_desc": MessageLookupByLibrary.simpleMessage(
            "Questo permetterà al membro di modificare i dettagli della comunità, i moderatori e gli utenti bloccati."),
        "community__moderator_resource_name":
            MessageLookupByLibrary.simpleMessage("moderatore"),
        ...
        "community__name_characters_error": MessageLookupByLibrary.simpleMessage(
            "Il nome può contenere solo caratteri alfanumerici e trattini bassi."),
        ...
        "community__refreshing":
            MessageLookupByLibrary.simpleMessage("Aggiornando la comunità"),
        "community__retry_loading_posts":
            MessageLookupByLibrary.simpleMessage("Tocca per riprovare"),
        "community__rules_empty_error": MessageLookupByLibrary.simpleMessage(
            "Le regole non possono essere vuote."),
        ...
        "community__save_community_label_title_hint_text":
            MessageLookupByLibrary.simpleMessage(
                "ad esempio Viaggi, Fotografia, Gaming."),
        ...
        "community__save_community_name_member_invites":
            MessageLookupByLibrary.simpleMessage("Inviti membri"),
        "community__save_community_name_member_invites_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "I membri possono invitare persone nella comunità"),
        ...
        "community__top_posts_excluded_communities_desc":
            MessageLookupByLibrary.simpleMessage(
                "Gestisci le comunità escluse dalla cronologia di esplorazione"),
        "community__top_posts_settings":
            MessageLookupByLibrary.simpleMessage("Esplora impostazioni"),
        "community__trending_in_all": MessageLookupByLibrary.simpleMessage(
            "Di tendenza in tutte le categorie"),
        "community__trending_in_category": m17,
        "community__trending_none_found": MessageLookupByLibrary.simpleMessage(
            "Nessuna comunità di tendenza trovata. Riprova tra qualche minuto."),
        "community__trending_refresh":
            MessageLookupByLibrary.simpleMessage("Aggiorna"),
        "community__type_private":
            MessageLookupByLibrary.simpleMessage("Privato"),
        ...
        "community__unfavorite_action": MessageLookupByLibrary.simpleMessage(
            "Rimuovi la comunità dalle preferite"),
        ...
        "contextual_account_search_box__suggestions":
            MessageLookupByLibrary.simpleMessage("Suggerimenti"),
        ...
        "drawer__account_settings":
            MessageLookupByLibrary.simpleMessage("Impostazioni Account"),
        "drawer__account_settings_blocked_users":
            MessageLookupByLibrary.simpleMessage("Utenti bloccati"),
        "drawer__account_settings_change_email":
            MessageLookupByLibrary.simpleMessage("Cambia Email"),
        ...
        "drawer__application_settings":
            MessageLookupByLibrary.simpleMessage("Impostazioni Applicazione"),
        "drawer__connections":
            MessageLookupByLibrary.simpleMessage("Connessioni"),
        "drawer__customize":
            MessageLookupByLibrary.simpleMessage("Personalizza"),
        "drawer__developer_settings":
            MessageLookupByLibrary.simpleMessage("Impostazioni sviluppatore"),
        "drawer__global_moderation":
            MessageLookupByLibrary.simpleMessage("Moderazione globale"),
        "drawer__help":
            MessageLookupByLibrary.simpleMessage("Assistenza & Feedback"),
        ...
        "drawer__my_mod_penalties": MessageLookupByLibrary.simpleMessage(
            "Le mie penalità di moderazione"),
        "drawer__my_pending_mod_tasks": MessageLookupByLibrary.simpleMessage(
            "I miei incarichi di moderazione in attesa"),
        ...
        "drawer__useful_links_guidelines":
            MessageLookupByLibrary.simpleMessage("Regolamento Openspace"),
        "drawer__useful_links_guidelines_bug_tracker":
            MessageLookupByLibrary.simpleMessage("Segnalazione Bug"),
        "drawer__useful_links_guidelines_bug_tracker_desc":
            MessageLookupByLibrary.simpleMessage(
                "Segnala un bug o vota bug esistenti"),
        "drawer__useful_links_guidelines_desc":
            MessageLookupByLibrary.simpleMessage(
                "Le regole che ci aspettiamo tutti seguiranno per una convivenza sana e amichevole."),
        "drawer__useful_links_guidelines_feature_requests":
            MessageLookupByLibrary.simpleMessage("Richiedi Funzionalità"),
        "drawer__useful_links_guidelines_feature_requests_desc":
            MessageLookupByLibrary.simpleMessage(
                "Richiedi una nuova funzionalità o vota le richieste esistenti"),
        "drawer__useful_links_guidelines_github":
            MessageLookupByLibrary.simpleMessage(
                "Scheda del progetto su Github"),
        "drawer__useful_links_guidelines_github_desc":
            MessageLookupByLibrary.simpleMessage(
                "Dai un\'occhiata a ciò a cui stiamo lavorando"),
        "drawer__useful_links_guidelines_handbook":
            MessageLookupByLibrary.simpleMessage("Manuale Openspace"),
        "drawer__useful_links_guidelines_handbook_desc":
            MessageLookupByLibrary.simpleMessage(
                "Un manuale con tutto quello che c\'è da sapere sull\'utilizzo della piattaforma"),
        "drawer__useful_links_slack_channel":
            MessageLookupByLibrary.simpleMessage("Canale Slack della comunità"),
        "drawer__useful_links_slack_channel_desc":
            MessageLookupByLibrary.simpleMessage(
                "Un luogo dove discutere tutto riguardo Openspace"),
        "drawer__useful_links_support":
            MessageLookupByLibrary.simpleMessage("Sostieni Somus"),
        "drawer__useful_links_support_desc":
            MessageLookupByLibrary.simpleMessage(
                "Trova un modo per sostenerci nel nostro viaggio!"),
        "drawer__useful_links_title":
            MessageLookupByLibrary.simpleMessage("Link utili"),
        "error__no_internet_connection": MessageLookupByLibrary.simpleMessage(
        ...
        "moderation__no_description_text":
            MessageLookupByLibrary.simpleMessage("Nessuna descrizione"),
        ...
        "moderation__report_account_text":
            MessageLookupByLibrary.simpleMessage("Segnala account"),
        "moderation__report_comment_text":
            MessageLookupByLibrary.simpleMessage("Segnala commento"),
        "moderation__report_community_text":
            MessageLookupByLibrary.simpleMessage("Segnala comunità"),
        "moderation__report_hashtag_text":
            MessageLookupByLibrary.simpleMessage("Segnala hashtag"),
        "moderation__report_post_text":
            MessageLookupByLibrary.simpleMessage("Segnala post"),
        "moderation__reporter_text":
            MessageLookupByLibrary.simpleMessage("Segnalatore"),
        "moderation__reports_preview_resource_reports":
            MessageLookupByLibrary.simpleMessage("segnalazioni"),
        ...
        "notifications__comment_desc": MessageLookupByLibrary.simpleMessage(
            "Ricevi una notifica quando qualcuno commenta un tuo post o un post che hai commentato."),
        "notifications__comment_reaction_desc":
            MessageLookupByLibrary.simpleMessage(
                "Ricevi una notifica quando qualcuno reagisce a uno dei tuoi commenti."),
        "notifications__comment_reaction_title":
            MessageLookupByLibrary.simpleMessage(
                "Pubblica reaction al commento"),
        "notifications__comment_reply_desc": MessageLookupByLibrary.simpleMessage(
            "Ricevi una notifica quando qualcuno risponde a un tuo post o a un post a cui hai risposto."),
        ...
        "notifications__comment_reply_title":
            MessageLookupByLibrary.simpleMessage("Risposta al commento"),
        "notifications__comment_title":
            MessageLookupByLibrary.simpleMessage("Pubblica commento"),
        "notifications__comment_user_mention_desc":
            MessageLookupByLibrary.simpleMessage(
                "Ricevi una notifica quando qualcuno ti cita su uno dei suoi commenti"),
        "notifications__comment_user_mention_title":
            MessageLookupByLibrary.simpleMessage(
                "Menzione nel commento di un post"),
        "notifications__community_invite_desc":
            MessageLookupByLibrary.simpleMessage(
                "Ricevi una notifica quando qualcuno ti invita unirti a una comunità."),
        "notifications__community_invite_title":
            MessageLookupByLibrary.simpleMessage("Invito comunità"),
        "notifications__community_new_post_desc":
            MessageLookupByLibrary.simpleMessage(
                "Ricevi una notifica quando c\'è un nuovo post in una comunità su cui hai attivato le notifiche dei post"),
        "notifications__community_new_post_tile": m27,
        "notifications__community_new_post_title":
            MessageLookupByLibrary.simpleMessage("Nuovo post comunità"),
        "notifications__connection_desc": MessageLookupByLibrary.simpleMessage(
            "Ricevi una notifica quando qualcuno desidera connettersi con te"),
        "notifications__connection_request_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] vuole connettersi con te."),
        "notifications__connection_title":
            MessageLookupByLibrary.simpleMessage("Richiesta di connessione"),
        ...
        "notifications__follow_title":
            MessageLookupByLibrary.simpleMessage("Segui"),
        "notifications__following_you_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] ha iniziato a seguirti."),
        "notifications__general_desc": MessageLookupByLibrary.simpleMessage(
            "Ricevi notifiche quando succede qualcosa"),
        "notifications__general_title":
            MessageLookupByLibrary.simpleMessage("Notifiche"),
        "notifications__mentioned_in_post_comment_tile": m28,
        "notifications__mentioned_in_post_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] ti ha menzionato in un post."),
        "notifications__mute_post_turn_off_post_comment_notifications":
            MessageLookupByLibrary.simpleMessage(
                "Disattiva notifiche ai commenti dei post"),
        "notifications__mute_post_turn_off_post_notifications":
            MessageLookupByLibrary.simpleMessage("Disattiva notifiche ai post"),
        "notifications__mute_post_turn_on_post_comment_notifications":
            MessageLookupByLibrary.simpleMessage(
                "Attiva notifiche ai commenti dei post"),
        "notifications__mute_post_turn_on_post_notifications":
            MessageLookupByLibrary.simpleMessage("Attiva notifiche ai post"),
        "notifications__post_reaction_desc": MessageLookupByLibrary.simpleMessage(
            "Ricevi una notifica quando qualcuno reagisce a uno dei tuoi post."),
        "notifications__post_reaction_title":
            MessageLookupByLibrary.simpleMessage("Pubblica reaction"),
        "notifications__post_user_mention_desc":
            MessageLookupByLibrary.simpleMessage(
                "Ricevi una notifica quando qualcuno ti cita su uno dei suoi post"),
        "notifications__post_user_mention_title":
            MessageLookupByLibrary.simpleMessage("Menzione in un post"),
        "notifications__reacted_to_post_comment_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] ha reagito al tuo commento."),
        "notifications__reacted_to_post_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] ha reagito al tuo post."),
        "notifications__settings_title":
            MessageLookupByLibrary.simpleMessage("Impostazioni notifiche"),
        "notifications__tab_general":
            MessageLookupByLibrary.simpleMessage("Generali"),
        "notifications__tab_requests":
            MessageLookupByLibrary.simpleMessage("Richieste"),
        "notifications__user_community_invite_tile": m29,
        "notifications__user_new_post_desc": MessageLookupByLibrary.simpleMessage(
            "Ricevi una notifica quando c\'è un nuovo post da parte di un utente di cui hai abilitato le notifiche"),
        "notifications__user_new_post_tile":
            MessageLookupByLibrary.simpleMessage(
                "[name] [username] ha postato qualcosa."),
        "notifications__user_new_post_title":
            MessageLookupByLibrary.simpleMessage("Nuovo post utente"),
        "permissions_service__camera_permission_denied":
            MessageLookupByLibrary.simpleMessage(
                "Richiediamo l\'autorizzazione per la fotocamera per permetterti di scattare foto e registrare video, per favore permettila nelle tue impostazioni."),
        "permissions_service__storage_permission_denied":
            MessageLookupByLibrary.simpleMessage(
                "Richiediamo il permesso di memorizzazione per poter selezionare elementi multimediali, per favore permettilo nelle impostazioni."),
        "post__action_comment":
            MessageLookupByLibrary.simpleMessage("Commenta"),
        ...
        "post__actions_comment_deleted":
            MessageLookupByLibrary.simpleMessage("Commento eliminato"),
        "post__actions_delete":
            MessageLookupByLibrary.simpleMessage("Elimina post"),
        "post__actions_delete_comment":
            MessageLookupByLibrary.simpleMessage("Elimina commento"),
        "post__actions_delete_comment_description":
            MessageLookupByLibrary.simpleMessage(
                "Il commento, così come le sue risposte e reazioni saranno definitivamente eliminati."),
        "post__actions_delete_description": MessageLookupByLibrary.simpleMessage(
            "Il post, così come i suoi commenti e le sue reazioni verranno eliminati definitivamente."),
        "post__actions_deleted":
            MessageLookupByLibrary.simpleMessage("Post eliminato"),
        "post__actions_edit_comment":
            MessageLookupByLibrary.simpleMessage("Modifica commento"),
        "post__actions_report_text":
            MessageLookupByLibrary.simpleMessage("Segnala"),
        "post__actions_reported_text":
            MessageLookupByLibrary.simpleMessage("Segnalato"),
        "post__actions_show_more_text":
            MessageLookupByLibrary.simpleMessage("Mostra altro"),
        "post__close_create_post_label":
            MessageLookupByLibrary.simpleMessage("Chiudi creazione nuovo post"),
        ...
        "post__comment_reply_expanded_reply_comment":
            MessageLookupByLibrary.simpleMessage("Rispondi al commento"),
        "post__comment_reply_expanded_reply_hint_text":
            MessageLookupByLibrary.simpleMessage("La tua risposta..."),
        ...
        "post__commenter_expanded_start_conversation":
            MessageLookupByLibrary.simpleMessage("Inizia la conversazione.."),
        "post__commenter_post_text":
            MessageLookupByLibrary.simpleMessage("Post"),
        "post__commenter_write_something":
            MessageLookupByLibrary.simpleMessage("Scrivi qualcosa..."),
        "post__comments_closed_post":
            MessageLookupByLibrary.simpleMessage("Post chiuso"),
        "post__comments_disabled":
            MessageLookupByLibrary.simpleMessage("Commenti disabilitati"),
        "post__comments_disabled_message": MessageLookupByLibrary.simpleMessage(
            "Commenti disabilitati per il post"),
        "post__comments_enabled_message": MessageLookupByLibrary.simpleMessage(
            "Commenti abilitati per il post"),
        "post__comments_header_be_the_first_comments":
            MessageLookupByLibrary.simpleMessage("Commenta per primo"),
        "post__comments_header_be_the_first_replies":
            MessageLookupByLibrary.simpleMessage("Rispondi per primo"),
        "post__comments_header_newer":
            MessageLookupByLibrary.simpleMessage("Più recenti"),
        "post__comments_header_newest_comments":
            MessageLookupByLibrary.simpleMessage("Commenti più recenti"),
        "post__comments_header_newest_replies":
            MessageLookupByLibrary.simpleMessage("Risposte più recenti"),
        "post__comments_header_older":
            MessageLookupByLibrary.simpleMessage("Più vecchi"),
        "post__comments_header_oldest_comments":
            MessageLookupByLibrary.simpleMessage("Commenti più vecchi"),
        "post__comments_header_oldest_replies":
            MessageLookupByLibrary.simpleMessage("Risposte più vecchie"),
        "post__comments_header_see_newest_comments":
            MessageLookupByLibrary.simpleMessage("Vedi i commenti più recenti"),
        "post__comments_header_see_newest_replies":
            MessageLookupByLibrary.simpleMessage(
                "Vedi le risposte più recenti"),
        "post__comments_header_see_oldest_comments":
            MessageLookupByLibrary.simpleMessage("Vedi i commenti più vecchi"),
        "post__comments_header_see_oldest_replies":
            MessageLookupByLibrary.simpleMessage(
                "Vedi le risposte più vecchie"),
        "post__comments_header_view_newest_comments":
            MessageLookupByLibrary.simpleMessage(
                "Visualizza i commenti più recenti"),
        "post__comments_header_view_newest_replies":
            MessageLookupByLibrary.simpleMessage(
                "Visualizza le risposte più recenti"),
        "post__comments_header_view_oldest_comments":
            MessageLookupByLibrary.simpleMessage(
                "Visualizza i commenti più vecchi"),
        "post__comments_header_view_oldest_replies":
            MessageLookupByLibrary.simpleMessage(
                "Visualizza le risposte più vecchie"),
        "post__comments_page_no_more_replies_to_load":
            MessageLookupByLibrary.simpleMessage(
                "Nessuna altra risposta da caricare"),
        "post__comments_page_no_more_to_load":
            MessageLookupByLibrary.simpleMessage(
                "Nessun altro commento da caricare"),
        "post__comments_page_replies_title":
            MessageLookupByLibrary.simpleMessage("Risposte al post"),
        "post__comments_page_tap_to_retry":
            MessageLookupByLibrary.simpleMessage(
                "Tocca per riprovare a caricare i commenti."),
        "post__comments_page_tap_to_retry_replies":
            MessageLookupByLibrary.simpleMessage(
                "Tocca per riprovare a caricare le risposte."),
        "post__comments_page_title":
            MessageLookupByLibrary.simpleMessage("Commenti del post"),
        ...
        "post__create_new_community_post_label":
            MessageLookupByLibrary.simpleMessage("Crea un nuovo post comunità"),
        "post__create_new_post_label":
            MessageLookupByLibrary.simpleMessage("Crea nuovo post"),
        ...
        "post__disable_post_comments": MessageLookupByLibrary.simpleMessage(
            "Disabilita i commenti per il post"),
        ...
        "post__profile_counts_following":
            MessageLookupByLibrary.simpleMessage(" Seguendo"),
        "post__profile_counts_post":
            MessageLookupByLibrary.simpleMessage(" Pubblica"),
        ...
        "post__reaction_list_tap_retry": MessageLookupByLibrary.simpleMessage(
            "Tocca per riprovare a caricare le reaction."),
        ...
        "post__sharing_post_to":
            MessageLookupByLibrary.simpleMessage("Condividi post con"),
        "post__text_copied":
        ...
        "post__timeline_posts_all_loaded":
            MessageLookupByLibrary.simpleMessage("🎉  Tutti i post caricati"),
        "post__timeline_posts_default_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "Prova ad aggiornare la timeline."),
        "post__timeline_posts_default_drhoo_title":
            MessageLookupByLibrary.simpleMessage("Qualcosa non va."),
        "post__timeline_posts_failed_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage("Riprova tra qualche secondo"),
        "post__timeline_posts_failed_drhoo_title":
            MessageLookupByLibrary.simpleMessage(
                "Impossibile caricare la tua timeline."),
        "post__timeline_posts_no_more_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "Segui gli altri utenti o unisciti a una comunità per iniziare!"),
        "post__timeline_posts_refresh_posts":
            MessageLookupByLibrary.simpleMessage("Aggiorna i post"),
        "post__timeline_posts_refreshing_drhoo_title":
            MessageLookupByLibrary.simpleMessage("Tieni duro!"),
        "post__top_posts_title":
            MessageLookupByLibrary.simpleMessage("Esplora"),
        "post__trending_posts_load_more":
            MessageLookupByLibrary.simpleMessage("Carica post più vecchi"),
        "post__trending_posts_no_trending_posts":
            MessageLookupByLibrary.simpleMessage(
                "Non ci sono post in tendenza. Prova ad aggiornare fra qualche secondo."),
        ...
        "post__world_circle_name":
            MessageLookupByLibrary.simpleMessage("Tutto il mondo"),
        "post__you_shared_with":
            MessageLookupByLibrary.simpleMessage("Hai condiviso con"),
        "post_body_link_preview__empty": MessageLookupByLibrary.simpleMessage(
            "Non può essere creata l’anteprima per questo link"),
        "post_body_link_preview__error_with_description": m36,
        "post_body_media__unsupported": MessageLookupByLibrary.simpleMessage(
        ...
        "post_uploader__cancelling":
            MessageLookupByLibrary.simpleMessage("Annullamento"),
        "post_uploader__compressing_media":
            MessageLookupByLibrary.simpleMessage(
                "Comprimendo il file media..."),
        "post_uploader__creating_post":
            MessageLookupByLibrary.simpleMessage("Creazione post..."),
        "post_uploader__generic_upload_failed":
            MessageLookupByLibrary.simpleMessage("Caricamento fallito"),
        "post_uploader__processing":
            MessageLookupByLibrary.simpleMessage("Elaborazione post..."),
        "post_uploader__publishing":
            MessageLookupByLibrary.simpleMessage("Pubblicazione post..."),
        "post_uploader__success":
            MessageLookupByLibrary.simpleMessage("Successo!"),
        "post_uploader__uploading_media": MessageLookupByLibrary.simpleMessage(
            "Caricamento del file media..."),
        "posts_stream__all_loaded":
            MessageLookupByLibrary.simpleMessage("🎉 Tutti i post caricati"),
        "posts_stream__empty_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "Prova ad aggiornare tra un paio di secondi."),
        "posts_stream__empty_drhoo_title":
            MessageLookupByLibrary.simpleMessage("Questo stream è vuoto."),
        "posts_stream__failed_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage(
                "Riprova tra un paio di secondi"),
        "posts_stream__failed_drhoo_title":
            MessageLookupByLibrary.simpleMessage(
                "Impossibile caricare lo stream."),
        "posts_stream__refreshing_drhoo_subtitle":
            MessageLookupByLibrary.simpleMessage("Aggiornamento dello stream."),
        "posts_stream__refreshing_drhoo_title":
            MessageLookupByLibrary.simpleMessage("Ancora un attimo!"),
        "posts_stream__status_tile_empty":
            MessageLookupByLibrary.simpleMessage("Nessun post trovato"),
        ...
        "user__add_account_to_lists":
            MessageLookupByLibrary.simpleMessage("Aggiungi account alla lista"),
        "user__add_account_update_account_lists":
            MessageLookupByLibrary.simpleMessage("Aggiorna account liste"),
        "user__add_account_update_lists":
            MessageLookupByLibrary.simpleMessage("Aggiorna Liste"),
        "user__billion_postfix":
            MessageLookupByLibrary.simpleMessage("miliardi"),
        "user__block_user":
            MessageLookupByLibrary.simpleMessage("Blocca utente"),
        ...
        "user__confirm_connection_add_connection":
            MessageLookupByLibrary.simpleMessage(
                "Aggiungi connessione alla cerchia"),
        ...
        "user__confirm_guidelines_reject_info":
            MessageLookupByLibrary.simpleMessage(
                "Non puoi usare Somus finché non accetti le linee guida."),
        "user__confirm_guidelines_reject_join_slack":
            MessageLookupByLibrary.simpleMessage("Entra nel canale Slack."),
        "user__confirm_guidelines_reject_title":
            MessageLookupByLibrary.simpleMessage("Rifiuto Linee guida"),
        ...
        "user__connections_header_circle_desc":
            MessageLookupByLibrary.simpleMessage(
                "La cerchia di tutte le tue connessioni viene aggiunto a."),
        "user__connections_header_users":
            MessageLookupByLibrary.simpleMessage("Utenti"),
        ...
        "user__delete_account_confirmation_goodbye":
            MessageLookupByLibrary.simpleMessage("Addio 😢"),
        ...
        "user__delete_account_current_pwd":
            MessageLookupByLibrary.simpleMessage("Password corrente"),
        "user__delete_account_current_pwd_hint":
            MessageLookupByLibrary.simpleMessage(
                "Inserisci la password attuale"),
        "user__delete_account_next":
            MessageLookupByLibrary.simpleMessage("Prossimo"),
        ...
        "user__disconnect_from_user_success":
            MessageLookupByLibrary.simpleMessage("Disconnesso con successo"),
        "user__edit_profile_bio":
            MessageLookupByLibrary.simpleMessage("Biografia"),
        "user__edit_profile_community_posts":
            MessageLookupByLibrary.simpleMessage("Post della comunità"),
        "user__edit_profile_delete":
            MessageLookupByLibrary.simpleMessage("Elimina"),
        "user__edit_profile_location":
            MessageLookupByLibrary.simpleMessage("Luogo"),
        "user__edit_profile_name": MessageLookupByLibrary.simpleMessage("Nome"),
        "user__edit_profile_pick_image":
            MessageLookupByLibrary.simpleMessage("Scegli immagine"),
        ...
        "user__email_verification_error": MessageLookupByLibrary.simpleMessage(
            "Oops! Il tuo token non è valido o scaduto, per favore riprova"),
        "user__email_verification_successful":
            MessageLookupByLibrary.simpleMessage(
                "Fantastico! La tua email è ora verificata"),
        "user__emoji_field_none_selected":
            MessageLookupByLibrary.simpleMessage("Nessun emoji selezionato"),
        "user__emoji_search_none_found": m45,
        "user__enable_new_post_notifications":
            MessageLookupByLibrary.simpleMessage(
                "Attiva le notifiche dei nuovi post"),
        "user__follow_button_follow_back_text":
            MessageLookupByLibrary.simpleMessage("Segui a tua volta"),
        ...
        "user__follow_lists_no_list_found":
            MessageLookupByLibrary.simpleMessage("Nessuna lista trovata."),
        "user__follow_lists_no_list_found_for": m46,
        "user__follow_lists_search_for":
            MessageLookupByLibrary.simpleMessage("Cerca una lista..."),
        ...
        "user__following_resource_name":
            MessageLookupByLibrary.simpleMessage("utenti seguiti"),
        ...
        "user__guidelines_desc": MessageLookupByLibrary.simpleMessage(
            "Per favore prenditi un momento per leggere e accettare le nostre linee guida."),
        ...
        "user__invites_accepted_group_item_name":
            MessageLookupByLibrary.simpleMessage("invito accettato"),
        "user__invites_accepted_group_name":
            MessageLookupByLibrary.simpleMessage("inviti accettati"),
        "user__invites_accepted_title":
            MessageLookupByLibrary.simpleMessage("Accettato"),
        "user__invites_create_create":
            MessageLookupByLibrary.simpleMessage("Crea"),
        "user__invites_create_create_title":
            MessageLookupByLibrary.simpleMessage("Crea invito"),
        "user__invites_create_edit_title":
            MessageLookupByLibrary.simpleMessage("Modifica invito"),
        "user__invites_create_name_hint":
            MessageLookupByLibrary.simpleMessage("ad esempio Mario Rossi"),
        ...
        "user__invites_email_hint":
            MessageLookupByLibrary.simpleMessage("es. mariorossi@email.com"),
        "user__invites_email_invite_text":
            MessageLookupByLibrary.simpleMessage("Invito email"),
        "user__invites_email_send_text":
            MessageLookupByLibrary.simpleMessage("Invia"),
        "user__invites_email_sent_text":
            MessageLookupByLibrary.simpleMessage("Email di invito inviata"),
        ...
        "user__invites_invite_text":
            MessageLookupByLibrary.simpleMessage("Invita"),
        "user__invites_joined_with": m51,
        "user__invites_none_left":
            MessageLookupByLibrary.simpleMessage("Non hai inviti disponibili."),
        "user__invites_none_used": MessageLookupByLibrary.simpleMessage(
            "Sembra che tu non abbia usato nessun invito."),
        "user__invites_pending":
            MessageLookupByLibrary.simpleMessage("In attesa"),
        "user__invites_pending_email": m52,
        "user__invites_pending_group_item_name":
            MessageLookupByLibrary.simpleMessage("invito in attesa"),
        "user__invites_pending_group_name":
            MessageLookupByLibrary.simpleMessage("inviti in attesa"),
        "user__invites_refresh":
            MessageLookupByLibrary.simpleMessage("Aggiorna"),
        "user__invites_share_email":
            MessageLookupByLibrary.simpleMessage("Condividi invito via email"),
        "user__invites_share_email_desc": MessageLookupByLibrary.simpleMessage(
            "Invieremo un\'email di invito a nome tuo con le istruzioni"),
        "user__invites_share_yourself": MessageLookupByLibrary.simpleMessage(
            "Condividi invito autonomamente"),
        "user__invites_share_yourself_desc":
            MessageLookupByLibrary.simpleMessage(
                "Scegli dalle app di messaggistica, ecc."),
        "user__invites_title":
            MessageLookupByLibrary.simpleMessage("I miei inviti"),
        ...
        "user__language_settings_title":
            MessageLookupByLibrary.simpleMessage("Impostazioni lingua"),
        ...
        "user__million_postfix":
            MessageLookupByLibrary.simpleMessage("milioni"),
        "user__profile_action_cancel_connection":
            MessageLookupByLibrary.simpleMessage(
                "Annulla richiesta di connessione"),
        ...
        "user__remove_account_from_list":
            MessageLookupByLibrary.simpleMessage("Rimuovi account dalle liste"),
        ...
        "user__save_connection_circle_create":
            MessageLookupByLibrary.simpleMessage("Crea cerchia"),
        "user__save_connection_circle_edit":
            MessageLookupByLibrary.simpleMessage("Modifica cerchia"),
        "user__save_connection_circle_hint":
            MessageLookupByLibrary.simpleMessage(
                "es. Amici, Famiglia, Lavoro."),
        ...
        "user__save_follows_list_create":
            MessageLookupByLibrary.simpleMessage("Crea lista"),
        "user__save_follows_list_edit":
            MessageLookupByLibrary.simpleMessage("Modifica lista"),
        "user__save_follows_list_emoji":
            MessageLookupByLibrary.simpleMessage("Emoji"),
        "user__save_follows_list_emoji_required_error":
            MessageLookupByLibrary.simpleMessage("L\'Emoji è richiesto"),
        "user__save_follows_list_hint_text":
            MessageLookupByLibrary.simpleMessage("es. Viaggi, Fotografia"),
        ...
        "user__tile_following":
            MessageLookupByLibrary.simpleMessage(" · Seguiti"),
        "user__timeline_filters_apply_all":
            MessageLookupByLibrary.simpleMessage("Applica filtri"),
        "user__timeline_filters_circles":
            MessageLookupByLibrary.simpleMessage("Cerchie"),
        "user__timeline_filters_clear_all":
            MessageLookupByLibrary.simpleMessage("Svuota tutto"),
        "user__timeline_filters_lists":
            MessageLookupByLibrary.simpleMessage("Liste"),
        "user__timeline_filters_no_match": m59,
        "user__timeline_filters_search_desc":
            MessageLookupByLibrary.simpleMessage("Cerca cerchie e liste..."),
        "user__timeline_filters_title":
            MessageLookupByLibrary.simpleMessage("Filtri timeline"),
        "user__translate_see_translation":
            MessageLookupByLibrary.simpleMessage("Mostra traduzione"),
        "user__translate_show_original":
            MessageLookupByLibrary.simpleMessage("Mostra testo originale"),
        "user__unblock_user":
            MessageLookupByLibrary.simpleMessage("Sblocca utente"),
        "user__uninvite":
            MessageLookupByLibrary.simpleMessage("Disdici l\'invito"),
        "user__update_connection_circle_save":
            MessageLookupByLibrary.simpleMessage("Salva"),
        "user__update_connection_circle_updated":
            MessageLookupByLibrary.simpleMessage("Connessione aggiornata"),
        "user__update_connection_circles_title":
            MessageLookupByLibrary.simpleMessage(
                "Aggiorna cerchie connessioni"),

...
class PostsApiService {
  ...
  static const REPLY_COMMENT_POST_PATH = 'api/posts/{postUuid}/comments/{postCommentId}/replies/';
  ...
  String _makeReplyCommentPostPath(String postUuid, int postCommentId) {
    return _stringTemplateService
        .parse(REPLY_COMMENT_POST_PATH, {'postUuid': postUuid, 'postCommentId': postCommentId});
  }
